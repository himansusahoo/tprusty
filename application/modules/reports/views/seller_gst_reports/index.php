...
<div class="row-fluid">
    <div class="card card-warning card-outline collapsed-card">
            ...
            <div class="row">
                ...
                <div class="col-9 form-group">
                    <div class="form-group col-6">
                        <label for="order_from_year" class="col-4 col-form-label no_rpad">From Date</label>
                        <div class="col-4">
                            <?php
                            $minYear = $dates->minY;
                            $minMonth = $dates->minM;
                    ...
                    <div class="form-group col-6" id="to_date_filter"  style = 'display:none'>
                        <label for="order_to_year" class="col-4 col-form-label">To Date</label>
                        <div class="col-4">
                            <?php
                            $attribute = array(
                                "name" => "order_to_year",
        ...
        <div class="card-footer text-muted" style="display:none;">
            <span class="float-right ml-2"><a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat float-right marginR10" id="clear_search">Clear</a></span>
            <span class="float-right"><a href="javascript:void(0)" class="btn btn-sm btn-info btn-flat float-right" id="search_report">Search</a></span>
        </div>
    </div>    
...
<?php echo form_close() ?>
<div class="row-fluid">
    <div class="col-12 no_pad table-responsive" id="dyna_datatable"></div>
</div>
