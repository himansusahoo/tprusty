...
<div class="row">
    ...
    <div class="col-2">        
        <div class="card card-warning card-outline">
            ...
            <div class="card-body">
                <div class="row">
                    <span style="margin: auto;font-size: 40px;"><i class="fas fa-user round_icon"></i></span>
                </div>
                <div class="row">
                        ...
                        <div class="card bg-light">
                            <form class="form-horizontal">
                                ...
                                <div class="card-footer">
                                    ...
                                    <span><input type="submit" class="btn btn-sm btn-warning float-right" id="" value="Next"></span>
                                    <span><input type="submit" class="btn btn-sm btn-primary float-right marginR5" id="" value="Save"></span>
                                </div>
                            </form>
                        </div>
