        ...
        <div  class="checkout" >
            <table>
                <tr>
                    ...
                    <td valign="top"><span style="font-size:20px; font-weight:bold"> <?php echo $cus_data->fname; ?><?php echo " " . $cus_data->lname;
        echo "<br>";
        ?> </span>
...
<?php foreach ($cart_data->result() as $rec_cart) { ?>
            ...
            <div  class="checkout" >
                <table width="100%" border="0" cellspacing="5">
                    ...
                    $total_price = 0;
                    foreach ($rder_query->result() as $rec_cart1) {
                        ?>
                        <tr>
                            ...
                            <td> <div class="checkout-img">  
                                ...
                                <div > 
                                    <?php
                                    $qr2 = $this->db->query("select name from product_general_info where product_id='$rec_cart1->product_id'");
                                    $rw2 = $qr2->row();
                                    echo "<b>" . $rw2->name . "</b>";
...
//    print_r($rw_sellername->business_name);}
                            ...
                            <td>
                                <?php
                                $qr2 = $this->db->query("select description from product_general_info where product_id='$rec_cart1->product_id'");
                                $rw2 = $qr2->row();
