...
class Desktop_pagesetup_model extends CI_Model {
	...
	function select_imgsize()
	{
		...
		$qr=$this->db->query("SELECT * FROM pagedesign_imagesize WHERE display_type='desktop' AND page_nm='homepage' AND culumns_count='$clmn_conunt' AND ".$screeshot_clmnname."!=''  ");
	...
	function add_pagesectioninfo()
	{
		...
		$qr_seciontbl=$this->db->query("SELECT max(Sec_id) as maxi_secid FROM desktopsite_pagesectioninfo WHERE page_id='1' AND page_name='home' ");
		...
		$qr_secionorderby=$this->db->query("SELECT max(Order_by) as maxi_orderby FROM desktopsite_pagesectioninfo WHERE page_id='1' AND page_name='home' ");
	...
	function section_dataof_desktophomepage()
	{
		$qr_section=$this->db->query("SELECT * FROM desktopsite_pagesectioninfo WHERE page_id='1' AND page_name='home' ORDER BY Order_by ");
		return $qr_section;	
	}
	...
	function homepagesectionsorby_up()
	{
		...
		$qr_sectionperv=$this->db->query("SELECT pgsection_sqlid FROM desktopsite_pagesectioninfo WHERE page_id='1' AND page_name='home' AND Order_by='$order_byprevsec' ");
	...
	function homepagesectionsorby_down()
	{
		...
		$qr_sectionnext=$this->db->query("SELECT pgsection_sqlid FROM desktopsite_pagesectioninfo WHERE page_id='1' AND page_name='home' AND Order_by='$order_bynextsec' ");
	...
	function  hompagesortby_section_movetop()
	{
		...
		$sql_sel_data=$this->db->query("SELECT MIN(Order_by)Order_by FROM desktopsite_pagesectioninfo WHERE page_id='1'");
	...
	function  hompagesortby_section_movedown() 
	{
		...
		$sql_sel_data=$this->db->query("SELECT MAX(Order_by) Order_by FROM desktopsite_pagesectioninfo WHERE page_id='1'");
		$exit_data=$sql_sel_data->row()->Order_by;
	...
	function delete_desktophomepage_section()
	{ $output_dir = "./images/pagedesign_image/";
		$sec_sqlid=$this->uri->segment(4);
