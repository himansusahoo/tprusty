...
class Postalcode_update_model extends CI_Model {
    ...
    function postalcode_process_statusstart() {
        $this->db->query("UPDATE postalpincode_process_status SET postalpincode_edit='process' WHERE status_id='1' ");
    }
    ...
    function postalcode_Upload() {
        if (!empty($_FILES['userfile']['name'])) {
            ...
            $excel_rndname = strtolower(random_string('alnum', 15)) . $dt_img . '.xls';
            ...
            if ($this->upload->do_upload('userFile')) {
                ...
                $inputFileName = './pincode_excelfile/' . $excel_rndname;
    ...
    function validwithinsert_upload($excl_filename) {
        ...
        $inputFileName = './pincode_excelfile/' . $excl_filename;
