...
class Desktop_pagecatlog_model extends CI_Model {
	...
	public function select_imgsize()
	{
		...
		$qr=$this->db->query("SELECT * FROM pagedesign_imagesize WHERE display_type='desktop' AND page_nm='catalog' AND culumns_count='$clmn_conunt' AND ".$screeshot_clmnname."!='' ");
	...
	public function add_pagesectioninfo()
	{
		...
		$qr_seciontbl=$this->db->query("SELECT max(Sec_id) as maxi_secid FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' ");
		...
		$qr_secionorderby=$this->db->query("SELECT max(Order_by) as maxi_orderby FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' ");
		...
		//print_r($data_sectioninfo);exit;
			...
			{	
				...
				$this->db->query("UPDATE desktopsite_pagesectioninfo SET menu_id='$newupdate_menulinksrlz'  
				                  WHERE page_id='3' AND page_name='catalog' AND sec_type='Product Catalog'");
	...
	public function section_dataof_desktopcatlog()
	{
		$qr_section=$this->db->query("SELECT * FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' ORDER BY Order_by ");
		return $qr_section;
	}
	...
	{	$pgsectionsqlid_strng='';
		...
		$qr_section=$this->db->query("SELECT pgsection_sqlid,menu_id FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' AND menu_id!='' ORDER BY Order_by ");
	...
	public function catlogsectionsorby_up()
	{
		...
		$qr_sectionperv=$this->db->query("SELECT pgsection_sqlid FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' AND Order_by='$order_byprevsec' ");		
	...
	public function catlogsectionsorby_down()
	{
		...
		$qr_sectionnext=$this->db->query("SELECT pgsection_sqlid FROM desktopsite_pagesectioninfo WHERE page_id='3' AND page_name='catalog' AND Order_by='$order_bynextsec' ");		
	...
	function  catalogsortby_section_totop()
	{
		//$sec_sqlid=$this->uri->segment(4);
		$sec_sqlid=$this->input->post('pgsec_sqlid');
		$sql_sel_data=$this->db->query("SELECT MIN(Order_by)Order_by FROM desktopsite_pagesectioninfo WHERE page_id='3'");
	...
	function  catalogsortby_section_todown()
	{
		//$sec_sqlid=$this->uri->segment(4);
		$sec_sqlid=$this->input->post('pgsec_sqlid');
		$sql_sel_data=$this->db->query("SELECT MAX(Order_by) Order_by FROM desktopsite_pagesectioninfo WHERE page_id='3'");
		$exit_data=$sql_sel_data->row()->Order_by;
	...
	public function delete_desktopcatlog_section()
	{ $output_dir = "./images/pagedesign_image/";
		//$sec_sqlid=$this->uri->segment(4);
	...
	{	
		$qr=$this->db->query(" SELECT * FROM category_menu_desktop WHERE  parent_id IN
							(SELECT dskmenu_lbl_id FROM category_menu_desktop WHERE 
							parent_id IN (SELECT dskmenu_lbl_id FROM category_menu_desktop WHERE
							 parent_id=0 AND is_active='Yes') AND is_active='Yes') AND is_active='Yes' ORDER BY dskmenu_lbl_id");
