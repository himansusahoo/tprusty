...
class Bulk_productdeletemodel extends CI_Model {
    ...
    /* public function searchby_bulknewprodfordelete()
      ...
      if($slr_name!='' && $catg_ids_string=='' && $attrbids_string=='')
      {
      ...
      {
      $qr=$this->db->query("SELECT product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
      WHERE a.lvl2 IN ($catg_ids_string)	GROUP BY sku LIMIT 1000
      ...
      INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
      INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
      WHERE b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id LIMIT 1000
      ...
      WHERE d.category IN ($catg_ids_string)	LIMIT 1000
      ...
      if($slr_name=='' && $catg_ids_string=='' && $attrbids_string!='')
      {
      $qr=$this->db->query("SELECT a.product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
      INNER JOIN product_setting b ON a.product_id=b.product_id
      WHERE b.attribut_set IN ($attrbids_string)	GROUP BY sku LIMIT 1000
      ...
      WHERE d.attribut_set IN ($attrbids_string) GROUP BY a.master_product_id LIMIT 1000

      UNION ALL


      SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
      INNER JOIN product_setting c ON c.product_id=b.product_id
      WHERE c.attribut_set IN ($attrbids_string) GROUP BY a.master_product_id LIMIT 1000
      ...
      INNER JOIN seller_product_setting b ON a.seller_product_id = b.seller_product_id
      INNER JOIN seller_product_image c ON a.seller_product_id = c.seller_product_id
      WHERE b.attribute_set IN ($attrbids_string)	LIMIT 1000
      ...
      {
      $qr=$this->db->query("SELECT product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
      INNER  JOIN seller_account_information b ON a.seller_id=b.seller_id  WHERE b.business_name LIKE  '%$slr_name%' AND a.lvl2 IN ($catg_ids_string)
      GROUP BY sku LIMIT 1000
      ...
      INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
      INNER JOIN  seller_account_information d ON d.seller_id=a.seller_id
      WHERE d.business_name LIKE  '%$slr_name%' AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id LIMIT 1000
      ...
      SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
      INNER JOIN 	seller_account_information c ON a.seller_id=c.seller_id
      WHERE c.business_name LIKE  '%$slr_name%' AND b.lvl2 IN ($catg_ids_string)  GROUP BY a.master_product_id LIMIT 1000
      ...
      WHERE d.business_name LIKE  '%$slr_name%' AND e.category IN ($catg_ids_string)	LIMIT 1000
      ...
      $qr=$this->db->query("SELECT a.product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
      INNER JOIN product_setting b ON a.product_id=b.product_id
      WHERE b.attribut_set IN ($attrbids_string) AND a.lvl2 IN ($catg_ids_string) 	GROUP BY sku LIMIT 1000
      ...
      INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
      INNER JOIN product_setting d ON d.product_id=b.product_id
      WHERE d.attribut_set IN ($attrbids_string) AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id LIMIT 1000
      ...
      SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
      INNER JOIN product_setting c ON c.product_id=b.product_id
      WHERE c.attribut_set IN ($attrbids_string) AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id LIMIT 1000
      ...
      INNER JOIN seller_product_image c ON a.seller_product_id = c.seller_product_id
      INNER JOIN seller_product_category d ON b.seller_product_id=d.seller_product_id
      WHERE b.attribute_set IN ($attrbids_string) AND d.category IN ($catg_ids_string)	LIMIT 1000
      ...
      INNER JOIN product_setting b ON a.product_id=b.product_id
      INNER  JOIN seller_account_information c ON a.seller_id=c.seller_id
      WHERE b.attribut_set IN ($attrbids_string) AND c.business_name LIKE  '%$slr_name%'	GROUP BY sku LIMIT 1000
      ...
      INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
      INNER JOIN product_setting d ON d.product_id=b.product_id
      INNER JOIN  seller_account_information e ON e.seller_id=b.seller_id
      WHERE d.attribut_set IN ($attrbids_string) AND e.business_name LIKE  '%$slr_name%' GROUP BY a.master_product_id LIMIT 1000
      ...
      WHERE c.attribut_set IN ($attrbids_string) AND  d.business_name LIKE  '%$slr_name%' GROUP BY a.master_product_id LIMIT 1000
      ...
      INNER JOIN seller_product_image c ON a.seller_product_id = c.seller_product_id
      INNER JOIN seller_account_information d ON b.seller_id=d.seller_id
      WHERE b.attribute_set IN ($attrbids_string) AND d.business_name LIKE  '%$slr_name%' 	LIMIT 1000
      ...
      INNER JOIN product_setting b ON a.product_id=b.product_id
      INNER  JOIN seller_account_information c ON a.seller_id=c.seller_id
      WHERE b.attribut_set IN ($attrbids_string) AND c.business_name LIKE  '%$slr_name%' AND a.lvl2 IN ($catg_ids_string)	GROUP BY sku LIMIT 1000
      ...
      INNER JOIN product_setting d ON d.product_id=b.product_id
      INNER JOIN  seller_account_information e ON e.seller_id=b.seller_id
      WHERE d.attribut_set IN ($attrbids_string) AND e.business_name LIKE  '%$slr_name%' AND b.lvl2 IN ($catg_ids_string)
      GROUP BY a.master_product_id LIMIT 1000
      ...
      INNER JOIN product_setting c ON c.product_id=b.product_id
      INNER JOIN 	seller_account_information d ON a.seller_id=d.seller_id
      WHERE c.attribut_set IN ($attrbids_string) AND  d.business_name LIKE  '%$slr_name%' AND b.lvl2 IN ($catg_ids_string)
      GROUP BY a.master_product_id LIMIT 1000
      ...
      INNER JOIN seller_account_information d ON b.seller_id=d.seller_id
      INNER JOIN seller_product_category e ON a.seller_product_id = e.seller_product_id
      WHERE b.attribute_set IN ($attrbids_string) AND d.business_name LIKE  '%$slr_name%' AND e.category IN ($catg_ids_string)  	LIMIT 1000
    ...
    public function searchby_bulknewprodfordelete() {
        ...
        if ($slr_name != '' && $catg_ids_string == '' && $attrbids_string == '') {
            $qr = $this->db->query("SELECT product_id,sku,name,prod_status,imag FROM cornjob_productsearch a 
			INNER  JOIN seller_account_information b ON a.seller_id=b.seller_id  WHERE b.seller_id='$seller_idsrch'
			GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
									   INNER JOIN  seller_account_information d ON d.seller_id=a.seller_id
									   WHERE d.seller_id='$seller_idsrch' GROUP BY a.master_product_id 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN 	seller_account_information c ON a.seller_id=c.seller_id									    
					  WHERE c.seller_id='$seller_idsrch' GROUP BY a.master_product_id 
			...
			SELECT a.seller_product_id AS product_id, a.sku, a.name, b.product_approve AS prod_status, c.catelog_img_url AS imag
										...
										INNER JOIN seller_product_image c ON a.seller_product_id = c.seller_product_id
										INNER JOIN seller_account_information d ON b.seller_id=d.seller_id
										WHERE d.seller_id='$seller_idsrch'	LIMIT 1000	  
        ...
        if ($slr_name == '' && $catg_ids_string != '' && $attrbids_string == '') {
            $qr = $this->db->query("SELECT product_id,sku,name,prod_status,imag FROM cornjob_productsearch a 
			 WHERE a.lvl2 IN ($catg_ids_string)	GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
				                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id 
									   INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id					   
									   WHERE b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id 
        ...
        if ($slr_name == '' && $catg_ids_string == '' && $attrbids_string != '') {
            $qr = $this->db->query("SELECT a.product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
			INNER JOIN product_setting b ON a.product_id=b.product_id 
			 WHERE b.attribut_set IN ($attrbids_string)	GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
									   INNER JOIN product_setting d ON d.product_id=b.product_id					   
									   WHERE d.attribut_set IN ($attrbids_string) GROUP BY a.master_product_id 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN product_setting c ON c.product_id=b.product_id					  									    
					  WHERE c.attribut_set IN ($attrbids_string) GROUP BY a.master_product_id 
        ...
        if ($slr_name != '' && $catg_ids_string != '' && $attrbids_string == '') {
            $qr = $this->db->query("SELECT product_id,sku,name,prod_status,imag FROM cornjob_productsearch a 
			INNER  JOIN seller_account_information b ON a.seller_id=b.seller_id  WHERE b.seller_id='$seller_idsrch' AND a.lvl2 IN ($catg_ids_string)
			GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
									   INNER JOIN  seller_account_information d ON d.seller_id=a.seller_id
									   WHERE d.seller_id='$seller_idsrch' AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN 	seller_account_information c ON a.seller_id=c.seller_id									    
					  WHERE c.seller_id='$seller_idsrch' AND b.lvl2 IN ($catg_ids_string)  GROUP BY a.master_product_id 
			...
			SELECT a.seller_product_id AS product_id, a.sku, a.name, b.product_approve AS prod_status, c.catelog_img_url AS imag
										...
										INNER JOIN seller_account_information d ON b.seller_id=d.seller_id
										INNER JOIN seller_product_category e ON a.seller_product_id = e.seller_product_id
										WHERE d.seller_id='$seller_idsrch' AND e.category IN ($catg_ids_string)	LIMIT 1000	  
        ...
        if ($slr_name == '' && $catg_ids_string != '' && $attrbids_string != '') {
            $qr = $this->db->query("SELECT a.product_id,sku,name,prod_status,imag FROM cornjob_productsearch a
			INNER JOIN product_setting b ON a.product_id=b.product_id 
			 WHERE b.attribut_set IN ($attrbids_string) AND a.lvl2 IN ($catg_ids_string) 	GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN seller_existingproduct_image c ON  c.seller_extproduct_id=a.seller_exist_product_id
									   INNER JOIN product_setting d ON d.product_id=b.product_id					   
									   WHERE d.attribut_set IN ($attrbids_string) AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN product_setting c ON c.product_id=b.product_id					  									    
					  WHERE c.attribut_set IN ($attrbids_string) AND b.lvl2 IN ($catg_ids_string) GROUP BY a.master_product_id 
        ...
        if ($slr_name != '' && $catg_ids_string == '' && $attrbids_string != '') {
			...
			INNER JOIN product_setting b ON a.product_id=b.product_id
			INNER  JOIN seller_account_information c ON a.seller_id=c.seller_id 
			 WHERE b.attribut_set IN ($attrbids_string) AND c.seller_id='$seller_idsrch'	GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN product_setting d ON d.product_id=b.product_id
									   INNER JOIN  seller_account_information e ON e.seller_id=b.seller_id					   
									   WHERE d.attribut_set IN ($attrbids_string) AND e.seller_id='$seller_idsrch' GROUP BY a.master_product_id 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN product_setting c ON c.product_id=b.product_id
					   INNER JOIN 	seller_account_information d ON a.seller_id=d.seller_id					  									    
					  WHERE c.attribut_set IN ($attrbids_string) AND  d.seller_id='$seller_idsrch' GROUP BY a.master_product_id 
			...
			SELECT a.seller_product_id AS product_id, a.sku, a.name, b.product_approve AS prod_status, c.catelog_img_url AS imag
										...
										INNER JOIN seller_product_image c ON a.seller_product_id = c.seller_product_id
										INNER JOIN seller_account_information d ON b.seller_id=d.seller_id																				
										WHERE b.attribute_set IN ($attrbids_string) AND d.seller_id='$seller_idsrch' 	LIMIT 1000	  
        ...
        if ($slr_name != '' && $catg_ids_string != '' && $attrbids_string != '') {
			...
			INNER JOIN product_setting b ON a.product_id=b.product_id
			INNER  JOIN seller_account_information c ON a.seller_id=c.seller_id 
			 WHERE b.attribut_set IN ($attrbids_string) AND c.seller_id='$seller_idsrch' AND a.lvl2 IN ($catg_ids_string)	GROUP BY sku 
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status, c.catelog_img_url AS                                       imag FROM seller_product_master a 
									   ...
									   INNER JOIN product_setting d ON d.product_id=b.product_id
									   INNER JOIN  seller_account_information e ON e.seller_id=b.seller_id					   
									   WHERE d.attribut_set IN ($attrbids_string) AND e.seller_id='$seller_idsrch' AND b.lvl2 IN ($catg_ids_string)
			...
			SELECT a.seller_exist_product_id AS product_id, a.sku, b.name, a.approve_status AS prod_status,b.imag FROM seller_product_master a                       INNER JOIN  cornjob_productsearch b ON a.master_product_id=b.product_id
					   INNER JOIN product_setting c ON c.product_id=b.product_id
					   INNER JOIN 	seller_account_information d ON a.seller_id=d.seller_id					  									    
					  WHERE c.attribut_set IN ($attrbids_string) AND  d.seller_id='$seller_idsrch' AND b.lvl2 IN ($catg_ids_string)
					   GROUP BY a.master_product_id 
			...
			SELECT a.seller_product_id AS product_id, a.sku, a.name, b.product_approve AS prod_status, c.catelog_img_url AS imag
										...
										INNER JOIN seller_account_information d ON b.seller_id=d.seller_id
										INNER JOIN seller_product_category e ON a.seller_product_id = e.seller_product_id																				
										WHERE b.attribute_set IN ($attrbids_string) AND d.seller_id='$seller_idsrch' AND e.category IN ($catg_ids_string)  	LIMIT 1000	  
