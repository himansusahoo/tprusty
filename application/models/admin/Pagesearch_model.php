...
class Pagesearch_model extends CI_Model {
    ...
    function select_imgsize() {
        ...
        $qr = $this->db->query("SELECT * FROM pagedesign_imagesize WHERE display_type='mobile' AND page_nm='searchpage' AND culumns_count='$clmn_conunt' AND " . $screeshot_clmnname . "!=''  ");
    ...
    function add_pagesectioninfo() {
        ...
        $qr_seciontbl = $this->db->query("SELECT max(Sec_id) as maxi_secid FROM mobilesite_pagesectioninfo WHERE page_id='5' AND page_name='searchpage' ");
        ...
        $qr_secionorderby = $this->db->query("SELECT max(Order_by) as maxi_orderby FROM mobilesite_pagesectioninfo WHERE page_id='5' AND page_name='searchpage' ");
        ...
        for ($i_clmn = 0; $i_clmn < $col_num; $i_clmn++) {
            ...
            for ($s = 0; $s < count($imgsqlid_hdn); $s++) {
                ...
                if ($img_sqlid != '') {
                    ...
                    /* $qr_clmnsqlid=$qr_clmnordby=$this->db->query("SELECT clmn_sqlid FROM mobilesite_columninfo 
                      WHERE page_id='5' AND sec_id='$Sec_id' AND clmn_id='$clmnid'  "); */
    ...
    function section_dataof_mobilesearch() {
        $qr_section = $this->db->query("SELECT * FROM mobilesite_pagesectioninfo WHERE page_id='5' AND page_name='searchpage' ORDER BY Order_by ");
        return $qr_section;
    }

    function pagesortby_section_movetop() {
        $sec_sqlid = $this->uri->segment(4);

        $sql_sel_data = $this->db->query("SELECT MIN(Order_by)Order_by FROM mobilesite_pagesectioninfo WHERE page_id='5'");
    ...
    function pagesortby_section_movedown() {
        $sec_sqlid = $this->uri->segment(4);

        $sql_sel_data = $this->db->query("SELECT MAX(Order_by) Order_by FROM mobilesite_pagesectioninfo WHERE page_id='5'");
        $exit_data = $sql_sel_data->row()->Order_by;
    ...
    function pagesectionsorby_up() {
        ...
        $qr_sectionperv = $this->db->query("SELECT pgsection_sqlid FROM mobilesite_pagesectioninfo WHERE page_id='5' AND page_name='searchpage' AND Order_by='$order_byprevsec' ");
    ...
    function pagesectionsorby_down() {
        $sec_sqlid = $this->uri->segment(4);
        ...
        $qr_sectionnext = $this->db->query("SELECT pgsection_sqlid FROM mobilesite_pagesectioninfo WHERE page_id='5' AND page_name='searchpage' AND Order_by='$order_bynextsec' ");
    ...
    function delete_mobilesearchpage_section() {
        $output_dir = "./images/pagedesign_image/";
        $sec_sqlid = $this->uri->segment(4);
