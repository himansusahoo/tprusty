...
//				$newheight5 = '80';
	...
	{
		$query=$this->db->query("SELECT * FROM bulkprod_templatelog a INNER JOIN  bulkproduct_reuploadlog b ON a.blk_tempid=b.uploadprod_uid GROUP BY b.uploadprod_uid ORDER BY a.blk_tempid DESC ");
