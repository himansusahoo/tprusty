...
class Page_single_product_model extends CI_Model {
	...
	public function select_imgsize()
	{
		...
		$qr=$this->db->query("SELECT * FROM pagedesign_imagesize WHERE display_type='mobile' AND page_nm='single product' AND culumns_count='$clmn_conunt' AND ".$screeshot_clmnname."!='' ");
	...
	public function add_pagesectioninfo()
	{
		...
		$data_array=array();
		if($check_id=='catid' ){
				$qr_selcatdata=$this->db->query("SELECT * FROM category_indexing 
				WHERE parent_id IN 
		...
		$qr_seciontbl=$this->db->query("SELECT max(Sec_id) as maxi_secid FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' ");
		...
		$qr_secionorderby=$this->db->query("SELECT max(Order_by) as maxi_orderby FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' ");
	...
	public function section_dataof_mobile_singleproduct()
	{
		$qr_section=$this->db->query("SELECT * FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' ORDER BY Order_by ");
		return $qr_section;
	}
	
	
	public function section_dataof_mobile_singleproductajx()
	{
		/*$qr_section=$this->db->query("SELECT * FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' ORDER BY Order_by ");
		return $qr_section;*/
		...
		$qr_section=$this->db->query("SELECT pgsection_sqlid,menu_id FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' AND menu_id!=''  ORDER BY Order_by ");
	...
	public function single_productsectionsorby_up()
	{
		...
		$qr_sectionperv=$this->db->query("SELECT pgsection_sqlid FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' AND Order_by='$order_byprevsec' ");		
	...
	public function single_productsectionsorby_down()
	{
		...
		$qr_sectionnext=$this->db->query("SELECT pgsection_sqlid FROM mobilesite_pagesectioninfo WHERE page_id='4' AND page_name='single product' AND Order_by='$order_bynextsec' ");		
	...
	function  single_productsortby_section_totop()
	{
		...
		$sql_sel_data=$this->db->query("SELECT MIN(Order_by)Order_by FROM mobilesite_pagesectioninfo WHERE page_id='4'");
	...
	function  single_productsortby_section_todown()
	{
		...
		$sql_sel_data=$this->db->query("SELECT MAX(Order_by) Order_by FROM mobilesite_pagesectioninfo WHERE page_id='4'");
		$exit_data=$sql_sel_data->row()->Order_by;
	...
	public function delete_mobile_singelproduct_section()
	{ $output_dir = "./images/pagedesign_image/";
		//$sec_sqlid=$this->uri->segment(4);
		$sec_sqlid=$this->input->post('pgsec_sqlid');
