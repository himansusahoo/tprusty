...
class Advance_searchmodel_count extends CI_Model {
	...
	//--------------------product add or modified  date initialize start -----------------//	
		...
		//-------------------------------------- query for attribute value start--------------------------------------------//
			...
			if($seller_idsrchstring!='' && $catg_ids_string!='' && $attrbgrouids_string!='' && $attrbvalueasqlis_string!='' && $addfromto_date_string=='' 					 && $modffromto_date_string=='')
			{
				 ...
				 $qr=$this->productdata_asattributrvalue($product_status,$seller_idsrchstring,$catg_ids_string,$attrbgrouids_string,$attrbvalueasqlis_string,$actualattrbid_string,$actualattrbvalue_string,$last_segment);			
	...
	function productdata_asattributrvalue($product_status,$seller_idsrchstring,$catg_ids_string,$attrbgrouids_string,$attrbvalueasqlis_string,$actualattrbid_string,$actualattrbvalue_string,$last_segment)
	{
		...
		if($product_status=='Active')
			{
				$qr=$this->product_attributefilter_as_seller($catg_id,$last_segment,$seller_idsrchstring,$product_status);
			...
			else
			{
				...
				{
					$qr=$this->inactiveproduct_attributefilter_as_seller($catg_id,$last_segment,$seller_idsrchstring,$product_status);
				}
				else
				{
					$qr=false;	
	...
	function product_attributefilter_as_seller($catg_id,$last_segmt,$seller_idsrchstring,$product_status)
	{
	...
	function inactiveproduct_attributefilter_as_seller($catg_id,$last_segmt,$seller_idsrchstring,$product_status)
	{
