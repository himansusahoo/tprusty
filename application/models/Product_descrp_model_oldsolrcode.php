...

{
	...
	$qr2=$this->db->query("select imag ,lvl2 as category_id,lvl2_name as category_name from cornjob_productsearch  WHERE lvl2 IN ($catg_id) AND product_id!=0 AND quantity>0 AND prod_status='Active' AND status='Enabled' AND seller_status='Active' AND imag!='' group by lvl2 ORDER BY product_id DESC  ");
...
//		
	...
	function select_product_searchfirstcount($search_title)
	{
		//----------------------------- solr search start------------------------------//
			...
			{	
				...
				$searchsuggst_txt=trim(str_replace(' ','%20AND%20',$sugword));	
				
				$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json&rows=1&start=0";
			...
			$qr2=$this->db->query("select a.sku,a.product_id  from cornjob_productsearch a WHERE a.quantity>0 AND a.seller_id!=0 AND a.prod_status = 'Active' AND a.status = 'Enabled' AND a.seller_status = 'Active' AND a.sku IN ($skuids_strng)  group by a.sku order by a.product_id DESC LIMIT 1");
	...
	{set_time_limit(0);
			...
			$curl_strng = SOLR_BASE_URL."mycollection1/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=12&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
			...
			{			
				...
				$curl_strng = SOLR_BASE_URL."mycollection1/spell?q=".$sugword_arr[$max_hitkey]."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=12&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
	...
	{		
		//----------------------------- solr search start------------------------------//
			...
			$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$search_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json&rows=50&start=0";
			...
			if($data2['response']['numFound']==0)
			{
				...
				$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json&rows=50&start=0";
			...
			$skuids_strng=implode(',',$sku_ids);
			$qr2=$this->db->query("select a.sku,a.product_id  from cornjob_productsearch a WHERE a.quantity>0 AND a.seller_id!=0 AND a.prod_status = 'Active' AND a.status = 'Enabled' AND a.seller_status = 'Active' AND a.sku IN ($skuids_strng)  group by a.sku ");
...
GROUP BY a.lvl2   ");
	...
	function select_categoryfor_searchpage($search_title)
	{
		//----------------------------- solr search start------------------------------//
			...
			$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$search_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json";
			...
			{	
				...
				$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json";
			...
			$skuids_strng=implode(',',$sku_ids);
			$qr2=$this->db->query("select a.lvl2 as category_id  from cornjob_productsearch a WHERE a.quantity>0 AND a.seller_id!=0 AND a.prod_status = 'Active' AND a.status = 'Enabled' AND a.seller_status = 'Active' AND a.sku IN ($skuids_strng)  group by a.lvl2 ");
	...
	function select_product_search_count($search_title){
		...
		//{
			...
			$curl_strng = SOLR_BASE_URL."mycollection1/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";			
			...
			{			
				...
				$curl_strng = SOLR_BASE_URL."mycollection1/spell?q=".$sugword_arr[$max_hitkey]."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=".$max_hits."&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
			...
			{			
				...
				$curl_strng = SOLR_BASE_URL."mycollection1/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=".$tot_rec."&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";			
	...
	function select_more_product_search_data($search_title)
	{
		...
		$limit = 50;
			...
			$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$search_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json&rows=".$limit."&start=".$tart."";
			...
			if($data2['response']['numFound']==0)
			{
				...
				$searchsuggst_txt=trim(str_replace(' ','%20AND%20',$sugword));	
				$curl_strng=SOLR_BASE_URL."mycollection1/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=lvl2_name&facet.field=lvl1_name&facet.field=lvlmain_name&facet.mincount=1&wt=json&rows=".$limit."&start=".$tart."";
			...
			$skuids_strng=implode(',',$sku_ids);
			$qr2=$this->db->query("select a.name, a.imag AS catelog_img_url,a.product_id,a.mrp,a.price,a.special_price,a.quantity,a.special_pric_from_dt,a.seller_id,a.special_pric_to_dt,a.sku , a.lvl2 as category_id    from cornjob_productsearch a WHERE a.quantity>0 AND a.seller_id!=0 AND a.prod_status = 'Active' AND a.status = 'Enabled' AND a.seller_status = 'Active' AND a.sku IN ($skuids_strng)  group by a.sku ");
...
function catg_brand_name_mobile($label_id)
	...
	function catch_data_insert($dskcatgid_id)
	{
		...
		if($this->uri->segment(2)==""){$snd_seg='index';}else{$snd_seg=$this->uri->segment(2);}
