...
//		
	...
	function select_product_searchfirstcount($search_title)
	{
		//----------------------------- solr search start------------------------------//
			...
			{	
				...
				$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json&rows=1&start=0";
	...
	{set_time_limit(0);
			...
			$curl_strng = "http://74.208.217.65:8983/solr/mycollection2_online/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=12&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
			...
			{			
				...
				$curl_strng = "http://74.208.217.65:8983/solr/mycollection2_online/spell?q=".$sugword_arr[$max_hitkey]."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=12&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
	...
	{		
		//----------------------------- solr search start------------------------------//
			...
			$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$search_title."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json&rows=50&start=0";
...
GROUP BY a.lvl2   ");
	...
	function select_categoryfor_searchpage($search_title)
	{
		//----------------------------- solr search start------------------------------//
			...
			$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$search_title."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json";
			...
			{	
				...
				$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json";
	...
	function select_product_search_count($search_title){
		...
		//{
			...
			$curl_strng = "http://74.208.217.65:8983/solr/mycollection2_online/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";			
			...
			{			
				...
				$curl_strng = "http://74.208.217.65:8983/solr/mycollection2_online/spell?q=".$sugword_arr[$max_hitkey]."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=".$max_hits."&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";
			...
			{			
				...
				$curl_strng = "http://74.208.217.65:8983/solr/mycollection2_online/spell?q=".$search_title."&wt=json&spellcheck=true&spellcheck.collate=true&spellcheck.build=true&rows=".$tot_rec."&start=0&fl=name,lvl2_name,lvl1_name,lvlmain_name,sku";			
	...
	function select_more_product_search_data($search_title)
	{
		...
		$limit = 50;
			...
			$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$search_title."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json&rows=".$limit."&start=".$tart."";
			...
			if($data2['response']['numFound']==0)
			{
				...
				$searchsuggst_txt=trim(str_replace(' ','%20',$sugword));	
				$curl_strng="http://74.208.217.65:8983/solr/mycollection2_online/select?indent=on&q=".$searchsuggst_txt."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json&rows=".$limit."&start=".$tart."";
