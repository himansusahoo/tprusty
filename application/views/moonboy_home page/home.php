            ...
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        ...
                        <?php /* ?> <a href="<?php echo base_url().'product_description/product_addtocart/'.$slider_box1[0]->box1_id.'/'.$slider_box1[0]->category_id ?>">  <img alt="Ethnic Wear" src="<?php echo base_url();?>images/slider/<?php echo $slider_box1[0]->box1_image; ?>"  /> <?php */ ?>
                    ...
                    <div class="item"> <?php /* ?> <a href="<?php echo base_url().'product_description/product_addtocart/'.$slider_box1[0]->box1_id.'/'.$slider_box1[1]->category_id ?>"><?php */ ?>
                        ...
                        <a href="<?php echo base_url() . 'selfie-sticks' ?>">
                            <img alt="Selfie Stick" src="<?php echo base_url(); ?>images/slider/<?php echo $slider_box1[1]->box1_image; ?>" /> </a> </div>

                    <div class="item">  <?php /* ?><a href="<?php echo base_url().'product_description/product_addtocart/'.$slider_box1[0]->box1_id.'/'.$slider_box1[2]->category_id ?>"><?php */ ?>

                        <a href="<?php echo base_url() . 'televisions' ?>">

                            <img alt="LED TV" src="<?php echo base_url(); ?>images/slider/<?php echo $slider_box1[2]->box1_image; ?>" /> </a> </div>

                    <div class="item">  
                        <?php /* ?> <a href="<?php echo base_url().'product_description/product_addtocart/'.$slider_box1[0]->box1_id.'/'.$slider_box1[3]->category_id ?>"><?php */ ?>  
                        <a href="<?php echo base_url() . 'mobile-batteries' ?>">

                            <img alt="Genuine Battery" src="<?php echo base_url(); ?>images/slider/<?php echo $slider_box1[3]->box1_image; ?>"  /> </a> </div>


                    <div class="item">  
                        <?php /* ?><a href="<?php echo base_url().'product_description/product_addtocart/'.$slider_box1[0]->box1_id.'/'.$slider_box1[4]->category_id ?>"><?php */ ?>

                        <a href="<?php echo base_url() . 'dress-material' ?>">


                            <img alt="Designer Kurtis
            ...
            if ($rows1 > 0) {
                foreach ($sub1_box1_info->result() as $row) {
                    ...
                    <div class="bnr-l"> <img alt="ad-banner" src="<?php echo './images/subpage/' . $row->image_name; ?>" />
                        ...
                        <?php /* ?><a href="<?php echo base_url().'product_description/product_addtocart/'.$row->image_id.'/'.$row->category_id ?>"> <?php */ ?>

                        <a href="<?php echo base_url() . 'lehenga-saree-lehenga' ?>"> 
        ...
        <div class="cont">
            <div class="off-section">
                ...
                if ($rows1 > 0) {
                    ...
                    <a href="<?php echo base_url() . 'clocks' ?>">
                ...
                if ($rows1 > 0) {
                    ...
                    ?>
                    <?php /* ?><a href="<?php echo base_url().'product_description/product_addtocart/'.$row->image_id.'/'.$row->category_id ?>"> <?php */ ?>
                    <a href="<?php echo base_url() . 'headphone-earphone' ?>">
                ...
                if ($rows1 > 0) {
                    ...
                    ?>
                    <?php /* ?><a href="<?php echo base_url().'product_description/product_addtocart/'.$row->image_id.'/'.$row->category_id ?>"> <?php */ ?>
                    <a href="<?php echo base_url() . 'decorative-handicraft' ?>">
                                ...
                                foreach ($result as $product) {
                                    ...
                                    <li>
                                        ...
                                        <div class="view view-fifth">
                                            <?php /* ?><a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($product->name)))).'/'.$product->product_id.'/'.$product->sku  ?>" ><?php */ ?>
                                        ...
                                        <div class="best-slr-data">
                                            ...
                                            <?php /* ?> <h2 class="product-name"><a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($product->name)))).'/'.$product->product_id.'/'.$product->sku  ?>" title="wallet"><?= substr($product->name,0,45).'...';?></a><?php */ ?>
                                            <a href="<?php echo base_url() . preg_replace('#"#', "-", preg_replace('#/#', "-", str_replace(" ", "-", strtolower($product->name)))) . '/' . $product->product_id . '/' . $product->sku ?>" title="wallet"><?= substr($product->name, 0, 45) . '...'; ?></a>
            ...
            <!-- Best Seller -->
            <div class="best-seller">
                <h3 class="title5"> <span> Trending Products </span> </h3>
                <?php
                $k = 0;
                        ...
                        <div class="container">
                            ...
                            <ul id="flexiselDemo3">
                                ...
                                foreach ($product_result_for_scroll1->result() as $presult) {
                                    ...
                                    <li><?php /* ?><a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($product->name)))).'/'.$presult->product_id.'/'.$presult->sku  ?>" ><?php */ ?>
