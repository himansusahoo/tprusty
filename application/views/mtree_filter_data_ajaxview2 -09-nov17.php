      ...
      <li>
          <a href="#" style="padding:8px 5px 1px;">
               <div class="single-bottom" title="Apple">
                    <input type="checkbox" onClick="filter_dataajax('<?php echo $mtree2id.$i_arrbrand.$i ?>')" id="<?php echo 'filter_productId'.$mtree2id.$i_arrbrand.$i ?>" name="filter_productId[]" value="<?php echo $id.'|'.$attribute.'|'.$filter_dataid['facet_counts']['facet_fields'][$attribute][$i] ?>">
                    <label for="<?php echo 'filter_productId'.$mtree2id.$i_arrbrand.$i ?>"><span></span> 
					<?php echo ucwords($filter_dataid['facet_counts']['facet_fields'][$attribute][$i]).'('.$filter_dataid['facet_counts']['facet_fields'][$attribute][$j].')'
