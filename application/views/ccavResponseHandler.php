...
<table>
<tr>
<td width="auto" style="text-align:justify; ">
<?php if($cart_data[0]->order_status=='Success') {?>
<span style="font-size:24px; font-weight:bold; color:#390">Thank You For Your Order!</span><br>
...
<span style="font-size:24px; font-weight:bold; color:#F00;">
