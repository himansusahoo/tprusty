      ...
      <tr>
        <td align="center" valign="top" style="padding:10px;">
          ...
          <table width="100%" bgcolor="#25203b" border="0" cellspacing="0" cellpadding="0" align="center">
            <tr>
           <td align="center" style="padding-bottom:3px;"> <span class="nav">
           <img src="https://www.moonboy.in/images/original_products.png" width="20" height="20" alt="" style="float:left;" /> Original Products </span> </td>
              <td align="center" style="padding-bottom:3px;"> <span class="nav">
              <img src="https://www.moonboy.in/images/cash_on.png" width="20" height="20" alt="" style="float:left;"/> Cash On Delivery </span> </td>
              <td align="center" style="padding-bottom:3px;"> <span class="nav">
              <img src="https://www.moonboy.in/images/easy_returns.png" width="20" height="20" alt="" style="float:left;" /> Easy Return </span> </td>
              <td align="center" style="padding-bottom:3px;"> <span class="nav">
              <img src="https://www.moonboy.in/images/secure_pay.png" width="20" height="20" alt="" style="float:left;" /> Secured Payment  </span> </td>
            </tr>      
          </table>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
             ...
             <tr>
             <td>
               <p class="gretings"> <strong> Hi Guest,</strong> <br /> <br /> </p>

               <p class="gretings"> Thank you for signing up with moonboy.in! <br /> <br />  </p>
               <p> <strong>Your Log in ID is :  <?=$email?> <br/>
                Password is as for your social</strong><br/><br/>
               <a href="https://www.moonboy.in" style="color:#6cb702; font-weight:bold; text-decoration:underline;" target="_blank">Login To moonboy.in</a>.
               <br /> <br />  </p>
              
              <p class="status"> <p>You can now log in to Moonboy using this ID and the social login password. </p><br/>
