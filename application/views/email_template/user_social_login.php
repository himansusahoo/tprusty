...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <meta name="format-detection" content="telephone=no">
            <title><?= uc_first(DOMAIN_NAME) ?> - Shop Your Heart Out!</title>  
                        ...
                        <table width="100%" bgcolor="#25203b" border="0" cellspacing="0" cellpadding="0" align="center">
                            <tr>
                                <td align="center" style="padding-bottom:3px;"> <span class="nav">
                                        <img src="<?= APP_BASE ?>images/original_products.png" width="20" height="20" alt="" style="float:left;" /> Original Products </span> </td>
                                <td align="center" style="padding-bottom:3px;"> <span class="nav">
                                        <img src="<?= APP_BASE ?>images/cash_on.png" width="20" height="20" alt="" style="float:left;"/> Cash On Delivery </span> </td>
                                <td align="center" style="padding-bottom:3px;"> <span class="nav">
                                        <img src="<?= APP_BASE ?>images/easy_returns.png" width="20" height="20" alt="" style="float:left;" /> Easy Return </span> </td>
                                <td align="center" style="padding-bottom:3px;"> <span class="nav">
                                        <img src="<?= APP_BASE ?>images/secure_pay.png" width="20" height="20" alt="" style="float:left;" /> Secured Payment  </span> </td>
                            </tr>      
                        </table>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="gretings"> Thank you for signing up with <?= DOMAIN_NAME ?>! <br /> <br />  </p>
                                    <p> <strong>Your Log in ID is :  <?= $email ?> <br/>
                                            Password is as for your social</strong><br/><br/>
                                        <a href="<?= APP_BASE ?>" style="color:#6cb702; font-weight:bold; text-decoration:underline;" target="_blank">Login To <?= DOMAIN_NAME ?></a>.
                                        <br /> <br />  </p>
