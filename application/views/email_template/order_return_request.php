                ...
                <tr>
                    <td align="center" valign="top" style="padding:10px;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="gretings"> Greetings from <?= DOMAIN_NAME ?> ! <br /> <br/></p>
                                    <p>We would like to inform you that we have received your return request for the following items in the Order <strong><?= $order_id ?></strong>.</p>
                                </td>              
                            </tr>               
                            ...
                            <tr> 
                                <td>
                                    <div class="notice">
                                        We are processing your return request and will revert with final approval status soon.
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table border="1" width="100%" class="prdct-dtls">
                                        <?php
                                        $rder_query = $this->db->query("select * from ordered_product_from_addtocart where order_id='$order_id' and user_id='$user_id' and sku='$sku'  group by sku ");
                        ...
                        <!--                <td> Item Price  <strong> Rs.(<?php //echo $rec_cart->sub_total_amount/$rec_cart->quantity;     ?>) </strong></td>
                                                ...
                                                <td> <strong>Return ID</strong>  <?= @$return_id ?> </td>
                            ...
                            <tr>
                                <td> <br/><br/>
                                    <p class="status"> We apologize for any inconvenience caused to you. </p>
