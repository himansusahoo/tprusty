          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
             ...
             <td>
               ...
               <p class="gretings"> Greetings from moonboy.in ! <br /> <br/></p>
               ...
               <tr> <td height="24"></td>  </tr>
                ...
                <?php $rder_query=$this->db->query("select * from ordered_product_from_addtocart where order_id='$order_id' and user_id='$user_id' and sku='$sku'  group by sku ");
