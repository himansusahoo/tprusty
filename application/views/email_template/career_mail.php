        ...
        <td align="center" valign="top" style="padding:10px;">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
             ...
             <tr>
             <td>
               <p class="gretings"> <strong> Dear,</br> Sir/Madam </strong> <br/><br/></p>

               <p class="gretings"> </p></br>
               <p> I have sent email with attachment kindly find this attachment on support@moonboy.in 
               <br/>
              </p>
              </br></br>
              <p class="status"> Details of Candidate: <strong></strong></p>
            ...
            <td>
              ...
              <p class="status">
                  ...
                  <strong>Name: <?php echo $fname; ?> </strong>  <br />
				  <strong>Email: <?php echo $email; ?> </strong>  <br />
				  <strong>Phone No: <?php echo $mob; ?> </strong>  <br />                                  
                 </p>
