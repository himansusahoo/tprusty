          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
             ...
             <td>
               ...
               <p class="gretings"> Greeting from moonboy.in! <br />  </p>
               <p> 
               <?php $query_sellername=$this->db->query("select a.business_name from seller_account_information a inner join ordered_product_from_addtocart b on a.seller_id=b.seller_id  where b.order_id='$order_id' group by order_id  ");   
