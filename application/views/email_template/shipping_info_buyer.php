                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p class="gretings"> Greeting from <?= DOMAIN_NAME ?>! <br />  </p>
                                    <p> 
                                        <?php
                                        $query_sellername = $this->db->query("select a.business_name from seller_account_information a inner join ordered_product_from_addtocart b on a.seller_id=b.seller_id  where b.order_id='$order_id' group by order_id  ");
                                        $rw_sellername = $query_sellername->row();
                                        ?>              
                                        <strong><?php echo $rw_sellername->business_name; ?></strong> has shipped 1 item in your order <strong><?php echo $order_id ?> </strong>. </p>
                                </td>
                            </tr>
                            <tr> <td height="24"></td>  </tr>
                            <tr> <td>
                                    <div class="notice"> The shipment was sent through:<span> <?php echo $courier_name; ?> </span><br />
                                        Shipment Tracking ID:<span> <?php echo $tracking_number; ?></span> <br />
                                        <p  class="status">  Tracking ID may take up to 24 hours to get activated. <br /> </p>
                                    </div>    
