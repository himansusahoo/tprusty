                ...
                <tr>
                    <td align="center" valign="top" style="padding:10px;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                 <!-- <p class="gretings"> <strong></strong> <br/><br/></p>-->
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="status">
                                                ...
                                                <strong>Dear <?php echo $fname1; ?> </strong>  <br />
                                                <strong>Order No.: <?php echo $rtorder_id; ?> </strong>  <br />
                                                Your Order has been Cancelled . For more details please contact at <?= SUPPORT_MAIL ?>            
                                            </p>
