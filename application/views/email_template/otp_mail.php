                ...
                <tr>
                    <td align="center" valign="top" style="padding:10px;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                    <p class="gretings"> <strong>Dear <?php echo $name; ?> ,</strong> 
                                    </p>

                                    <p class="gretings"> </p></br>
                                    <p>As requested your OTP for <?= DOMAIN_NAME ?> is:
                                        <br/>
                                        OTP: <?php echo $otp; ?>
                                    </p>
                                    </br></br>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="status">
                                                ...
                                                <strong>To reset your password, Please use the above OTP</strong>  <br />                
                                            </p>
