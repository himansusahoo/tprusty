                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p> We will send you another email once the items in your order have been shipped. Meanwhile, you can check the status of your order on <?= DOMAIN_NAME ?> 
                                        <a href="<?= APP_BASE ?>" style="color:#6cb702; font-weight:bold; text-decoration:underline;" target="_blank">TRACK ORDER</a>. <br/><br/>
                                    </p>
