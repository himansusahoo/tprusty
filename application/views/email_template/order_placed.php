          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
             ...
             <td>
               ...
               <p> We will send you another email once the items in your order have been shipped. Meanwhile, you can check the status of your order on moonboy.in 
               <a href="https://www.moonboy.in" style="color:#6cb702; font-weight:bold; text-decoration:underline;" target="_blank">TRACK ORDER</a>. <br/><br/>
              </p>
  ...
  $total_price=0; foreach($rder_query->result() as $rec_cart){ ?>
   ...
   ?>              
    ...
    ?> <img src="<?php echo base_url().'images/product_img/'.$image_cart[0]; ?>" width="50" height="50" style="float:left;">
				...
				echo $rec_cart->sub_total_amount; $total_price=$total_price+ $rec_cart->sub_total_amount; ?></td>
                </tr>
                <tr> 
                <?php } ?>
                <td colspan="5" align="right">
                <span style="font-size:16px;"><strong>Total  Rs. <?php
				
				$qr_order=$this->db->query("SELECT * FROM order_info WHERE order_id='$order_id' ");
				
				echo $qr_order->row()->Total_amount;
				//echo $total_price;
