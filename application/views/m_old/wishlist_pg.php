 <?php include 'header.php'; ?>   
 	...
 	<div class="view-product">
				...
				<!--/cart-->
				  <div class="checkout">
				      <h3 class="tittle two"> My Wishlist </h3>
						...
						<div class="list">
                        <?php $count_wishlist=$wishlist_products->num_rows(); ?>
						  <h3> <?=$count_wishlist?> Items in Your Wishlist</h3>
			...
			?>	                            
	                            <div class="cart_box">
								  <div class="message">
       							 ...
       							 <!--- price calculation div end here --->
                                        ...
                                        <input type="button"  value="View Details" class="btn-save" onClick="window.open('<?php echo base_url().'product_description/product_detail/'.preg_replace('#/#',"-",str_replace(" ","-",strtolower($wishlist_result->name))).'/'.$wishlist_result->product_id.'/'.$wishlist_result->sku; ?>','_blank')">
                                        </div>
                                ...
                                <?php //echo substr($wishlist_result->description,0,100).'...';?><a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#/#',"-",str_replace(" ","-",strtolower($wishlist_result->name))).'/'.$wishlist_result->product_id.'/'.$wishlist_result->sku; ?>"> View More </a>
                                <!--<p>  premium quality...     </p>-->
