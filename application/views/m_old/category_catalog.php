	...
	if(lastseg == 'NOT'){
       ...
       <div class="info-products">
		...
		?>
				...
				<input type="button" class="btn-sign-in"  value="View more" name="button" onClick="ShowMoreData('<?=$no_of_product;?>','<?=$label_id;?>','<?php if($this->uri->segment(4) != ''){ echo $this->uri->segment(4);}else{ echo 'NOT';}?>')">
				<?php }	?>
           </div>
