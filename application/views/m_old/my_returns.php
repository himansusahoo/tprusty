        ...
        <!-- Order -->
	      ...
	      <div class="list">
                              ...
                              <div class="clearfix"> </div>
                               <?php
                            $query = $this->db->query("SELECT a.id,a.sub_total_amount,a.quantity,a.product_order_status,a.order_id,a.prdt_color,a.prdt_size,b.name,b.product_id,b.description,
