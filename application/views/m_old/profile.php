    ...
    <div role="tabpanel" class="tab-pane active" id="tab1">
       <div class="login-frm">
            	<table width="100%">
                    ...
                    <tr>  <td>Mobile Number <div class="wrapper"><i class="fa fa-question-circle"></i>
                      <div class="tooltip">To change mobile number, Email OTP verification is mandatory</div></div> </td> </tr>
        			<tr>  <td>
                    ...
                    <tr>  <td>Gender</td> </tr>
        			<tr> <td>
         <div class="single-bottom"><label class="radio"><input type="radio" name="sex" value="Male" <?php if($persional_info[0]->gendr == 'Male'){ echo 'checked';} ?> checked> <span></span>Male</label> </div>
         <div class="single-bottom"> <label class="radio"><input type="radio" name="sex" value="Female" <?php if($persional_info[0]->gendr == 'Female'){ echo 'checked';} ?>><span></span>Female</label> </div>
                        </td>
                    </tr>
                    <tr>
        				<td >
