...
<div class="order-details">
    ...
    <tr> <td> Seller: </td> <td> <a target="_blank" href="<?php echo base_url() ;?>sellers/<?= base64_encode($this->encrypt->encode($result[0]->seller_id));?>"><?= $result[0]->business_name ;?></a> </td> </tr>
    ...
    <tr> <td> Status : </td> <td> <?= ucwords($result[0]->order_status) ; ?>
    ...
    <h3> Santanu Pati  </h3>
     <p> Contact no. : 9439776267  <br>
         Kalia Nagar, Pandara, Rasulgarh   <br>
         Bhubaneswar, Odisha - 751025,  <br>
         India
    </p>
    </div>
