...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active"> <a href="http://www.moonboy.in/product_description/product_addtocart/34/223">  <img alt="" src="<?php echo base_url()?>mobile_css_js/images/banner1.jpg"  width="" height="" /> </a>  </div>
    <div class="item"> <a href="http://www.moonboy.in/product_description/product_addtocart/34/85"> <img alt="" src="<?php echo base_url()?>mobile_css_js/images/banner2.jpg"  width="" height="" /> </a> </div>
    <div class="item"> <a href="http://www.moonboy.in/product_description/product_addtocart/34/148"> <img alt="" src="<?php echo base_url()?>mobile_css_js/images/banner3.jpg"  width="" height="" /> </a> </div>
    <div class="item"> <a href="http://www.moonboy.in/product_description/product_addtocart/34/82"> <img alt="" src="<?php echo base_url()?>mobile_css_js/images/banner4.jpg"  width="" height="" /> </a> </div>
    <div class="item"> <a href="http://www.moonboy.in/product_description/product_addtocart/34/225"> <img alt="" src="<?php echo base_url()?>mobile_css_js/images/banner5.jpg"  width="" height="" /> </a> </div>
						...
						<div class="col-sm-6 banner-bottom">
								<a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($product->name)))).'/'.$product->product_id.'/'.$product->sku  ?>" >
                                    ...
                                    <div class="product-thumb">
										<?php $file=base_url().'images/product_img/'.$product->catelog_img_url; 
			...
			<!--<span class="active total" style="display:block;" data-toggle="modal" data-target="#myModal"><strong>All Products</strong> (Select your Product)</span>-->
						...
						<div>
							<div class="prdct-category">
									<?php foreach($prodinfo_nmresult as $product){
...
<!--products-->
		...
		<div class="box-in">
            ...
            <?php foreach($product_result_for_scroll1->result() as $presult){ ?>
							<div class="product-thumb">
                             ...
                             <?php $file=base_url().'images/product_img/'.$presult->catelog_img_url; 
  ...
  <!--//products-main-->
    ...
    <div class="ftr-banner">  <a href="http://www.moonboy.in/product_description/product_addtocart/6/225" > <img src="<?php echo base_url().'mobile_css_js/' ?>images/banner-ftr.jpg" width="645" height="283" alt="" class="img-responsive"> </a> </div>
