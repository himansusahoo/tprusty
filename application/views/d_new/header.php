...
<head>
    ...
    <script>
  		 function search_url()
		 {
			 ...
			 if(val!="")
			 {
				window.location.href='<?php echo base_url().'demo/search-by/'?>'+val ; 
			 }
...
<!----------------------------------------Header Section start------------------------------------------------------>
 ...
 <div class="nav-middle"> 
       ...
       <!--<form onsubmit="search_url()"> -->  
        <input type="text" id="search-text" onKeyDown="if(event.keyCode==13) search_url();" name="search" placeholder="Search Your Product" autocomplete="off" required > 
