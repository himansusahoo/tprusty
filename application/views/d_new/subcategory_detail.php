...
<div class="container" style="width: 100%; margin-top: 58px; padding: 0; background:#f3f3f3; padding:5px;">
	...
	<div class="row" style="margin-top:10px;">
		...
		<!-------------------------------------------- 1st Section End ------------------------------------------>
		<div class="col-md-9" style="width:81%; background:#fff; padding-top:10px; box-shadow: 0 2px 4px 0 rgba(0, 0, 0, .08);float:right;">
			...
			<div class="row">
				...
				<div class="col-lg-6" style="border-right:5px solid #ccc">
					<div style="width:98%; margin:auto;">
					<div id="jssor_<?=$jsor?>" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:500px;overflow:hidden;visibility:hidden;">
						<!-- Loading Screen -->
