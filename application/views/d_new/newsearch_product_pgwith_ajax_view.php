...
<html lang="en">
	<head>
        ...
        //$curl_strng=SOLR_BASE_URL."mycollection2_offline/select?indent=on&q=".$search_title."&group=true&group.query=(Spec5:*%20OR%20Spec6:*%20OR%20Spec7:*)&group.query=*:*&wt=json&useParams=mainFacet";
			$curl_strng=SOLR_BASE_URL."mycollection2_offline/select?indent=on&q=".$search_title."&facet=true&facet.field=Category_Lvl3&facet.field=Category_Lvl2&facet.field=Category_Lvl1&facet.mincount=1&wt=json&rows=1&start=0&useParams=mainFacet&facet.pivot=Category_Lvl1,Category_Lvl2,Category_Lvl3";			
	...
	?>
		<meta name="Description" content="<?php echo 'Moonboy.in:'.str_replace("%20"," ",$this->uri->segment(3)).','.$category_lvl3 ;?>">
		<meta name="Keywords" content="<?php echo str_replace("%20"," ",$this->uri->segment(3)).','.$category_lvl3.',Moonboy.in' ;?>" />
		<title><?php echo 'Moonboy.in:'.str_replace("%20"," ",$this->uri->segment(3).'-'.$category_lvl3) ;?></title>
<?php }else{?>
		<meta name="Description" content="<?php echo 'Moonboy.in:'.str_replace("%20"," ",$this->uri->segment(3)) ;?>">
		<meta name="Keywords" content="<?php echo str_replace("%20"," ",$this->uri->segment(3)).',Moonboy.in' ;?>" />
		<title><?php echo 'Moonboy.in:'.str_replace("%20"," ",$this->uri->segment(3)) ;?></title>
<?php }?>
...
function ShowMoreData(result_no){
	...
	}else{var shownumItems=numItems+50;}
...
<!-- end grids_of_4 -->
           ...
           <div id="view_more_dv" class="grid_view_morebtn" >
           		<img src="https://www.moonboy.in/images/loader.gif" id="lodr_img" class="grid_view_lodr_img" style="display:none;">
...
<!-- end grids_of_4 -->
           ...
           <div id="view_more_dv" class="list_view_morebtn" >
           		<img src="https://www.moonboy.in/images/loader.gif" id="lodr_img" class="list_view_lodr_img" style="display:none;">
                				<input style="display:none;" type="button" id="" class="add-to-cart view_mor" value="View More" name="button" onclick="">
		</div>
