...
<div class="container" style="width: 100%; padding:5px; margin-top:60px;">
	<div class="row" style="background:#fff;">
		...
		<div class="col-md-8">
            ...
            <li class="active"><a href="<?php echo base_url().$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3) ?>"><?php if(strlen($recd1->name)>25){ echo substr($recd1->name,0,25).'...';} else {echo $recd1->name;} ?> </a></li>
		</ul>
        </div>
        <div class="col-md-4">
    ...
    <?php /*$newprodsku_checkforimg=$this->uri->segment(3); 
	$qr_newimage=$this->db->query("Select new_sku FROM bulkproductupload_log WHERE new_sku='$newprodsku_checkforimg' "); 
	
	$extprodqr_newimage=$this->db->query("Select new_sku FROM bulk_existingproductupload_log WHERE new_sku='$newprodsku_checkforimg' ");
	
	if($qr_newimage->num_rows()>0 || $extprodqr_newimage->num_rows()>0){ */
	?>
    ...
    <!------image upload by bulk process check end----->  
        <div class="col-md-7" >
        	<div class="desc1">
					<h1 class="single_prdct_title"><?php $prodnm_forgoogle=$recd1->name; echo $recd1->name; ?> </h1>
                    <div class="row">
                    	<div class="col-lg-8">
...
<div class="row">
	<div class="col-lg-5">
    	<div class="right-button-helder">
			<?php  $this->db->cache_on(); $query_curclolr=$this->db->query("SELECT seller_status FROM cornjob_productsearch WHERE sku='$data_sku' group by sku "); 
...
<div class="row" style="width:98%; margin:auto; border-bottom:2px solid #333;">
  ...
  <!--<div class="row">
  	<div class="col-lg-12">
      <p class="left-long-text">This item is Eligible For Return/ Replacement <sup>*</sup>, Buyer has to initiate within 5 Days of Reciept of the Shipment. Know More about the <a href="<?php echo base_url().'return-policy'?>">Return Policy.</a></p>
 ...
 <div class="row" style="width:98%; margin:auto;">
  	<div class="col-lg-12">
        ...
        <ul> 
		<li style="text-align:justify;"><?php $proddescrp_forgoogle= stripslashes($recd1->description); echo str_replace('\\', '', $recd1->description); ?></li>
    	<!--<li>  </li>-->
   </ul>
  ...
  <!--<div class="row" style="width:98%; margin:auto;">
	...
	<?php /*?><div class="row" style="width:98%; margin:auto;">
		<?php 
