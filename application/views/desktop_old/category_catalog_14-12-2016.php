...
function resetAllFilter(){
	window.onload = $('#limg').css('display','block');
	window.location.href='<?php echo base_url();?>product_description/category_catalog/<?=$this->uri->segment(3);?>/<?=$this->uri->segment(4);?>';
}
...
function resetFilterIndivisually(cat_name,cat_id,total_param,reset_param){
	...
	window.location.href='<?php echo base_url();?>product_description/category_catalog/'+cat_name.replace(" ","-")+'/'+cat_id+'/'+res;
}
