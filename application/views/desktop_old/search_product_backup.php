										...
										<li>
											<a href="<?php echo base_url().$thirddlvl_bredcummenu ?>">
											 ...
											 if($thirddlvl_bredcummenudisplay!='' ){
												//echo ($search_keyword);  
												if($this->session->userdata('srchsugst_solrword'))
												{echo $this->session->userdata('srchsugst_solrword');}
...
<?php /*?><a href="<?php echo base_url().'product_description/product_addtocart/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($row_prd->lvl2_name)))).'/'.$row_prd->lvl2 ?>"><?php */?>

<a href="<?php echo base_url().preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($row_prd->name)))).'/'.$row_prd->product_id.'/'.$row_prd->sku  ?>" >

<!--<img src="<?php //echo base_url().'images/product_img/'.$row_prd->imag; ?>" style="height:50px; width:50px;">&nbsp;-->
 <?php 
 echo ($row_prd->name); ?> <!--&nbsp; in-->
<b><?php
 //echo ($row->lvl1_name); ?></b>
 </a>
