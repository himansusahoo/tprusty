  ...
  <div class="clearfix">  </div>  
    <!-- related Products --> 
                    ...
                    <table class="table-striped table-hover othr_slr_prdt_tble" width="100%">
						...
						<tr>
                            ...
                            <?php   if(@$this->session->userdata['session_data']['user_id']!=""){
								 if($quantity==0 || $other_slr_product->status=='Disabled'|| $other_slr_product->approve_status =='Inactive'){
			...
			<?php } ?>
             ...
             <?php } else if($quantity==0 || $other_slr_product->status=='Disabled'|| $other_slr_product->approve_status =='Inactive'){?>
