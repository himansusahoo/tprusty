            ...
            <h2 class="title3">Registered Office</h2>
				<div class="top_faq" style="margin-top:30px;">
				 <h4 class="price-orange" > Moonboy International Pvt Ltd. </h4>
                   <p class="contact-right-text"> 12/2710, 1st Floor, Khajotiya House <br>
                    Aga No Wad, Sayedpura <br>
					   Surat, Gujarat, India - 395003 <br>              
                  <strong> CIN No : U70102GJ2011PTC063868 </strong> <br>
			      <strong> GSTIN : 24AAGCM9691L1ZS </strong> <br>
                  <strong> Service Tax No : AAGCM9691LSD001 </strong> <br>
			      <strong>  Email :  support@moonboy.in</strong> 
					</p>
				</div>
			</div>
   </div>         
