...
if (isset($search_prodclause['spellcheck']['collations']) && count($search_prodclause['spellcheck']['collations']) > 0) {

    $seg2val = $search_prodclause['spellcheck']['collations']['collationQuery'];
...
<ul>	
    <?php //echo '<pre>';print_r(array_unique($category_Lvl3_arr));	 ?>
