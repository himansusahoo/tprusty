...
//								}
					 ...
					 <?php  //if($attribute_size != false){
                        ...
                        <h4> Size: </h4>
							 ...
							 ?> 
                             <label  class="size">  
                            <input type='radio' id='attr_size' name='attr_size'  value='<?php echo $rw_extngsku[0]->size; ?>' <?php if($rw_extngsku[0]->size==$curnt_size){echo "checked='checked'";} ?>  onClick="window.location.href='<?php echo base_url().'product_description/product_detail/'.$prod_nm.'/'.@$rw_extngsku[0]->product_id.'/'.$sku_select; ?>'" />	<span class="size-box"><?=$rw_extngsku[0]->size;?></span>	</label> </li> 
