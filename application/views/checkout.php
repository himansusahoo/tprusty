                                ...
                                <tr>
                                    ...
                                    <td> <div class="checkout-img">  
                                        ...
                                        <div class="chckout-desc"> 
                                            <?php
                                            $qr2 = $this->db->query("select name,weight from product_general_info where product_id='$rec_cart->product_id' GROUP BY product_id ");
                                            $rw2 = $qr2->row();
...
//	array_push($size_arr,$size_val);
                                            ...
                                            if ($color_sizecronjobquery->num_rows() > 0) {
                                                ...
                                                if ($color_rw != '') {
                                                    echo "<span class='cart_attr'>Color : " . $color_rw . '</span><br/>';
                                                } else {
                                                    $color_rw = 'not';
                                                }array_push($color_arr, $color_rw);
                                                if ($size_rw != '') {
                                                    echo "<span class='cart_attr'>Size : " . $size_rw . '</span><br/>';
                                                } else {
                                                    $size_rw = 'not';
                                                }array_push($size_arr, $size_rw);
                                                if ($capacity != '') {
