...
<?php ?>
                                    ...
                                    <?php
                                    $query = $this->db->query("select a.business_name,a.seller_id,b.shipping_fee_amount from seller_account_information a inner join product_master b on a.seller_id=b.seller_id where b.product_id='$product_data->product_id' and b.sku='$data_sku'");
                                    $ct = $query->num_rows();
                                    $rew = $query->row();
                                    ?> 
...
<?php } ?>
                                    ...
                                    <?php
                                    $query = $this->db->query("select a.business_name,a.seller_id,b.quantity,b.stock_availability,a.display_name,b.max_qty_allowed_in_shopng_cart from seller_account_information a inner join product_master b on a.seller_id=b.seller_id where b.product_id='$product_data->product_id' and b.sku='$data_sku'");
                                    $ct = $query->num_rows();
                                    $rew = $query->row();
                            ...
                            <div class="col-md-4">
                                <div class="sold-by">
                                    ...
                                    <a href="<?php echo base_url(); ?>sellers/<?= base64_encode($this->encrypt->encode($rew->seller_id)); ?>" id="goslr" style="cursor:pointer !important;" target="_blank"> <?php
                                        if ($ct != 0) {
...
//								}
                                    ...
                                    if ($curnt_color != '') {
                                            ...
                                            foreach ($rw_extngskugrp as $res_extngsku) {
                                                ...
                                                if ($rw_extngsku[0]->color != '') {
                                                    ...
                                                    <li> <?php if ($rw_extngsku[0]->quantity <= 0 || $rw_extngsku[0]->quantity == '') { ?><div class="not-available"> </div><?php } ?>
                                                        <label  class="color"> 
                                                            <input type='radio' id='attr_colr' name='attr_colr'  value='<?php echo $rw_extngsku[0]->color; ?>' <?php
                                                            if ($curnt_color == $rw_extngsku[0]->color) {
                                                                echo "checked='checked'";
                                                            }
                                                            ?>  onClick="window.location.href = '<?php echo base_url() . 'product_description/product_detail/' . $prod_nm . '/' . $rw_extngsku[0]->product_id . '/' . $rw_extngsku[0]->sku; ?>'" />	<span> <i style="background-color:<?php
                                                                   if ($rw_extngsku[0]->color != 'Multicolor') {
                                                                       echo $rw_extngsku[0]->color;
                                                                   }
                                                                   ?>;" <?php
                                                                                                                                                                                                                                                          if ($rw_extngsku[0]->color == 'Multicolor') {
                                                                                                                                                                                                                                                              echo "class='multicolor'";
                                                                                                                                                                                                                                                          }
                                                                                                                                                                                                                                                          ?> title="<?= $rw_extngsku[0]->color; ?>" > </i> </span> 	 
                                                        </label>
                                                    </li>
                                        ...
                                        <?php
                                    } // if color not blank condition end
                                        ...
                                        <ul class="size_list">
                                            ...
                                            foreach ($rw_extngsku as $res_extngsku) {
                                                ...
                                                if ($rw_extngsku[0]->size != '') {
                                                    ...
                                                    <li> <?php if ($rw_extngsku[0]->quantity <= 0 || $rw_extngsku[0]->quantity == '') { ?><div class="not-available"> </div><?php } ?> 
                                                        <label  class="size">  
                                                            <input type='radio' id='attr_size' name='attr_size'  value='<?php echo $rw_extngsku[0]->size; ?>' <?php
                                                            if ($rw_extngsku[0]->size == $curnt_size) {
                                                                echo "checked='checked'";
                                                            }
                                                            ?>  onClick="window.location.href = '<?php echo base_url() . 'product_description/product_detail/' . $prod_nm . '/' . @$rw_extngsku[0]->product_id . '/' . $rw_extngsku[0]->sku; ?>'" />	<span class="size-box"><?= $rw_extngsku[0]->size; ?></span>	</label> </li> 
                                            ...
                                            foreach ($rw_extngsku as $res_extngsku) {
                                                ...
                                                if ($rw_extngsku[0]->Capacity != '') {
                                                    ...
                                                    <li> 
                                                        ...
                                                        <label  class="size">  
                                                            <input type='radio' id='attr_capcity' name='attr_capcity'  value='<?php echo $rw_extngsku[0]->Capacity; ?>' <?php
                                                            if ($rw_extngsku[0]->Capacity == $cur_capacity) {
                                                                echo "checked='checked'";
                                                            }
                                                            ?>  onClick="window.location.href = '<?php echo base_url() . 'product_description/product_detail/' . $prod_nm . '/' . @$rw_extngsku[0]->product_id . '/' . $rw_extngsku[0]->sku; ?>'" />	<span class="size-box"><?= $rw_extngsku[0]->Capacity; ?></span>	</label> </li> 
                                        ...
                                        <ul class="size_list">
                                            ...
                                            foreach ($rw_extngsku as $res_extngsku) {
                                                ...
                                                if ($rw_extngsku[0]->RAM != '') {
                                                    ...
                                                    <li> <?php if ($rw_extngsku[0]->quantity <= 0 || $rw_extngsku[0]->quantity == '') { ?><div class="not-available"> </div><?php } ?> 
                                                        <label  class="size">  
                                                            <input type='radio' id='attr_ram' name='attr_ram'  value='<?php echo $rw_extngsku[0]->RAM; ?>' <?php
                                                            if ($rw_extngsku[0]->RAM == $cur_ram) {
                                                                echo "checked='checked'";
                                                            }
                                                            ?>  onClick="window.location.href = '<?php echo base_url() . 'product_description/product_detail/' . $prod_nm . '/' . @$rw_extngsku[0]->product_id . '/' . $rw_extngsku[0]->sku; ?>'" />	<span class="size-box"><?= $rw_extngsku[0]->RAM; ?></span>	</label> </li> 
                                        ...
                                        <ul class="size_list">
                                            ...
                                            foreach ($rw_extngsku as $res_extngsku) {
                                                ...
                                                if ($rw_extngsku[0]->ROM != '') {
                                                    ...
                                                    <li> <?php if ($rw_extngsku[0]->quantity <= 0 || $rw_extngsku[0]->quantity == '') { ?><div class="not-available"> </div><?php } ?> 
                                                        <label  class="size">  
                                                            <input type='radio' id='attr_rom' name='attr_rom'  value='<?php echo $rw_extngsku[0]->ROM; ?>' <?php
                                                            if ($rw_extngsku[0]->ROM == $cur_rom) {
                                                                echo "checked='checked'";
                                                            }
                                                            ?>  onClick="window.location.href = '<?php echo base_url() . 'product_description/product_detail/' . $prod_nm . '/' . @$rw_extngsku[0]->product_id . '/' . $rw_extngsku[0]->sku; ?>'" />	<span class="size-box"><?= $rw_extngsku[0]->ROM; ?></span>	</label> </li> 
                ...
                <div id="other_product_dv">
                    ...
                    if ($other_seller_product_row > 0) {
                        ...
                        foreach ($other_seller_product->result() as $other_slr_product) {
                            ?><?php } ?>
                        <h3>Sold by other <span class="no_slr_spn"><?= $other_seller_product_row; ?></span> <?php
                            if ($other_seller_product_row == 1) {
                                echo 'Seller';
                            } else {
                                echo 'Sellers';
                            }
