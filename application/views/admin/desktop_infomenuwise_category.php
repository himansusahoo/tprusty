						...
						<img src="<?php echo base_url().'images/success_icon.png' ?>">&nbsp<?php echo $this->session->flashdata('flshmsg'); ?></div> <?php } ?>
                            ...
                            <!--Data Display from page section table start-->                            	
                                	<tr id=tblrow<?=$res_secinfo['pgsection_sqlid']?>> 
                                        ...
                                        <div id="process_div<?=$res_secinfo['pgsection_sqlid']?>" style="display:none; color:#090;"> <img src="<?php echo base_url().'images/progress.gif' ?>" />Please Wait... </div><div id="div_imgsize"></div></td> 
                                        <td> 
                                   <?php
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_category/product.png'; ?>" >								
                                   <?php } ?>
                                   ...
                                   <?php } ?>
                                    	...
                                    	<td><?php if($sort_i>1) {?>
												...
												<span style="float:right;"><a class="fa fa-angle-double-up" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Top" onClick="catlogsortby_section_movetopajx('<?=$res_secinfo['pgsection_sqlid']?>')"> </a></span>
                                            <?php } ?><br>
                                    		<?php if($sort_i!=$sec_ctr){  ?>
												...
												<span><a style="cursor: pointer; color:#333" onClick="catlogsortby_section_downajx('<?=$res_secinfo['pgsection_sqlid']?>')">Down</a></span>
												<span style="float:right;"><a class="fa fa-angle-double-down" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Buttom" onClick="catlogsortby_section_movedownajx('<?=$res_secinfo['pgsection_sqlid']?>')"> </a></span>
											<?php } ?>
                                    	</td>
										<td>
                                        <a href="<?php echo base_url().'admin/desktop_page_category/edit_desktopcategorysection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">
                                        <img src='<?php echo base_url().'images/icon_finder/1495194794_edit-notes.ico' ?>' style="width:33px;height:29px;cursor:pointer;" >
										&nbsp;</a>
										<span><a style="cursor: pointer; color:#333;" href="<?php echo base_url().'admin/desktop_page_category/edit_desktopcategorysection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">Edit </a></span><br>
