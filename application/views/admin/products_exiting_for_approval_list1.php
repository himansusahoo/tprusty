				...
				<div>
					<table class="table table-bordered">
                     ...
                     <?php
						...
						<tr class="table table-bordered" style="background-color:#FC6;color:#FFF;">
						...
						<tr class="filter_tr">	<td></td>
                            ...
                            <td><input type="number" name="mrp" value="" min="0" autocomplete="off"></td>
                            <td><input type="number" name="sell_prices" value="" min="0" autocomplete="off"></td>
                            <td><input type="number" name="quantity" value="" min="0" autocomplete="off"></td>
							<td>
