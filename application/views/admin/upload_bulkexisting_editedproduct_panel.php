...
<!-- Lightbox link end here-->
 ...
 <div class="row content-header" style="background-color:#099;">
				<h3 style="margin-top:0px; font-weight:bold;"><span style="color:#FFF;">Upload Bulk Existing Edited Products</span></h3>
  ...
  <!---------------------------------------------Category Listing End-------------------------------->
    ...
    <!-- @start #right-content -->
          ...
          <!-- <div class="right-cont" style="width:80%;">-->
           ...
           <div class="form_view">
						<h3>Upload Bulk Existing Edited Products </h3>
       ...
       <div id="file_uploaddiv" align="center" class="alert alert-info alert-dismissable" style="display:block; background-color:#9CF;">
        ...
        <?php
			...
			echo form_open_multipart('admin/Upload_existing_editedproductexcelfile/upload_extprodexcel', $attributes);
...
{  
	...
	{ 
		$('#process_div').css('display','block');
			$.ajax({
            url :'<?php echo base_url().'admin/Upload_existing_editedproductexcelfile/upload_extprodexcel' ?>',  
            type : 'POST',
            data : formData,
            async : true,
            cache : false,
...
function confirm_tosaveproduct(fileuploadid,confsts)
{
	...
	$.ajax({
					method:"POST",
					url:"<?php echo base_url(); ?>admin/Upload_existing_editedproductexcelfile/upload_editedexitingproduct_afterconfirmprodexcel",
