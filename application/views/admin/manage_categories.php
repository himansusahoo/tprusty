...
$CI =& get_instance();
    ...
    $str= $_SERVER['QUERY_STRING'] ? $url.'?'.$_SERVER['QUERY_STRING'] : $url;
 ...
 echo "<script>
		...
		$('.form_view').find('#tab4').addClass('in active');
		...
		$('.tabs-horiz').find('#li_tab4').addClass('active');
		});
	...
	<div id="content">    
		...
		<?php if(@$data==true){ ?><div align="center" style="color:#0C6"> <?php  echo $data ?> </div> <?php } ?>
          ...
          <form id="save_catgory_form" method="post" action="<?php echo base_url().'admin/catalog/save_category' ?>">
		   ...
		   <div class="col-md-8"> <b>Add New Root Category </b></div>
           ...
           <div class="col-md-4 show_report">
               ...
               <?php /*?> <input  type="button" class="all_buttons" value="Add Subcategory" onClick="window.location.href='<?php echo base_url().'admin/catalog/add_subcategory' ?>' " /><?php */?>
				...
				<input  type="submit" class="all_buttons" value="Save" onClick="return valid()"/>
        ...
        <?php } ?>
           ...
           <div id="show_error" align="center" style="color:#F00;"> </div>
			...
			<ul class="nav nav-tabs tabs-horiz">
				...
				<li id="li_tab4"><a data-toggle="tab" href="#tab4">Category List</a></li>
			</ul>
                ...
                <form action="<?php echo base_url().'admin/catalog/filter_category' ?>" method="post" >
					...
					<div>
						<table class="table table-bordered">
							<tr class="table_th">
								<!--<th width="5%" class="a-center">Select  Record</th>-->
								<th width="10%">ID</th>
								<th width="20%">Name</th>
                            ...
                            <!--<td><input type="checkbox"> </td>-->
								...
								<td><input type="text" name="active_from" ></td>
                                <td><input type="text" name="active_to" ></td>
								<td>
