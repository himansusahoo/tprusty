...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/mobile_category_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/page_category/add_pagecategorydata',$attributes);
					?>
					...
					<div class="row content-header">
                        ...
                        <div class="col-md-4 show_report">
                         ...
                         <button type="button" id="section_submit" class='all_buttons' style="background-color:#C03;float:right; font-weight:bold; height:32px; width:72px;" onClick="window.location.href='<?php echo base_url().'admin/Page_category/addnewcategory_formobilehomepage' ?>'" >
                                                    ...
                                                    <label id="lbl_section_type" style="font-size:18px;"> </label>
                                                        <select name="section_type" id="section_type" class="text2" onChange="populate_sectiondatatype(this.value)">
                                                           ...
                                                           <!-- <option value="Video">Video</option>-->
                                                            ...
                                                            <!--<option value="Prodcts Vertical section">Prodcts Vertical section</option>-->
