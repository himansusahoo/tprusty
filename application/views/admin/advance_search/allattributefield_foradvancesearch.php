...
<div class="bs-example form_content">
	<div class="panel-group" id="accordion<?=$accrod_id?>">
            ...
            <div class="panel">
                               ...
                               <input type="checkbox" id="attrbfld_chkbox<?=$td_id?>" name="attrbfld_chkbox[]" value="<?=$res_subattrb['attribute_field_name'] ?>"/>
                               <input type="checkbox" id="attrbfldselected_chkbox<?=$td_id?>" name="attrbfldselected_chkbox[]" value="<?=$res_subattrb['attribute_field_name'] ?>"/>
                                    ...
                                    onclick="allattrubute_valuepopulate('<?=$res_subattrb['attribute_id']?>','<?=$td_id?>','<?=$res_subattrb['attribute_field_name'] ?>')">
