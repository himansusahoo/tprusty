<table class="table table-bordered table-hover"> 
						...
						<img src="<?php echo base_url().'images/success_icon.png' ?>">&nbsp<?php echo $this->session->flashdata('flshmsg'); ?></div> <?php } ?>
                            ...
                            <!--Data Display from page section table start-->                            	
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_catlog/product.png'; ?>" >								
                                   <?php } ?>
                                   ...
                                   <?php } ?>
										...
										<td>
											<a href="<?php echo base_url().'admin/desktop_page_catlog/edit_desktopcatlogsection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">
											<img src='<?php echo base_url().'images/icon_finder/1495194794_edit-notes.ico' ?>' style="width:33px;height:29px;cursor:pointer;" >
											&nbsp;</a>
											<span><a style="cursor: pointer; color:#333;" href="<?php echo base_url().'admin/desktop_page_catlog/edit_desktopcatlogsection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">Edit </a></span><br>
