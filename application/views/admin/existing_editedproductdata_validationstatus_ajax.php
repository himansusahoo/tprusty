...
$qr_uplod=$this->db->query("SELECT uploadprod_sqlid,uploadprod_uid,qc_status from bulk_existing_editedproductupload_log WHERE uploadprod_uid='$uploded_id' AND upload_status='Pending' AND editstatus='Edited' AND master_productid!='' ");
