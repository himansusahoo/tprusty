...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/mobile_homepage_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/page_setup/add_pagesectiondata',$attributes);
					?>
                	<!--<form onSubmit="return membershipInfo()">-->
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Section Of Mobile Home Page</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
					...
					<div class="form_view">
						<h3>Add New Section Of Mobile Home Page</h3>
							<div width="100%">
                            		 <!----------------------Main table start------------------------>
                            <table>
                            <tr>
								...
								<tr>
                                    ...
                                    <label id="lbl_section_type" style="font-size:18px;"> </label>
                                    	<select name="section_type" id="section_type" class="text2" onChange="populate_sectiondatatype(this.value)">
                                            ...
                                            <option value="Recently Viewed Items">Recently Viewed Items</option>
