                    ...
                    if ($result != false) {
                        ...
                        foreach ($result->result() as $rows) {
                            ...
                            <tr>
                                ...
                                <td><?php
                                    if (strtolower($rows->business_name) == strtolower(COMPANY)) {
                                        echo 'Added By Admin';
                                    } else {
                                ...
                                <td><?= $rows->quantity; ?></td>
                                <td><?php
                                    $prodadddt = substr($rows->add_date, 0, 10);
