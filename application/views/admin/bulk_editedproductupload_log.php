...
<div id="content">
 ...
 <div class="row content-header">
             ...
             <div class="exist_prod_new_list" align="right"><button type="button" onclick="window.location.href='<?php echo base_url(). 'admin/Bulkproduct_edit/bulkproduct_editpanel/'.$seller_id ?>' ">Edit Bulk Product &nbsp;<i class="fa fa-upload" aria-hidden="true"></i>
</button>  </div>
</div>
		<!-------------------------------------------Listing start--------------------------------------------------------------------->
                     ...
                     <div class="col-md-6 right">
					  ...
					  <div>
                       ...
                       <form action="<?php echo base_url().'admin/sales/filter_order' ?>" method="post" >
                           ...
                           <?php /*?> <span style="cursor:pointer;" onclick="<?php echo base_url().'admin/download_bulkproducttemp/generate_failedproductexcelsheet/'.$res_uploadlist['blk_tempid'].'/'.$res_uploadlist['category_id'].'/'.$res_uploadlist['attribute_set'].'/'.$seller_id ?>"><img src="<?php echo base_url().'images/Excel.png' ?>" width="30" height="30"  title="Download Failed Or Pending Product Excel Sheet"/></span> <?php */?>
                          
                                                  <?php /*?> <button id="faild_product" class="seller_buttons" onclick="window.location.href='<?php echo base_url().'admin/Bulkproduct_edit/generate_failededitedproductexcelsheet/'.$res_uploadlist['blk_tempid'].'/'.$res_uploadlist['category_id'].'/'.$res_uploadlist['attribute_set'].'/'.$seller_id ?>' " title="Download Failed Or Pending Product Excel Sheet" ><i class="fa fa-download" aria-hidden="true" style="color:#FFF;"></i> &nbsp;Download</button><?php */?>
