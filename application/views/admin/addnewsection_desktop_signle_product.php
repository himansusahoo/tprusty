...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/desktop_single_product_addsectionjs.php'); ?>
                	<?php
					$attributes = array('onSubmit' => 'return valid_columndata()');
					echo form_open_multipart('admin/Desktop_page_single_product/addpage_single_productdata',$attributes);
					?>
                	<!--<form onSubmit="return membershipInfo()">-->
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Section Of Single Product Page</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
                        <div class="col-md-4 show_report">
                        
                         <button type="button" id="section_submit" class='all_buttons' style="background-color:#C03;float:right; font-weight:bold; height:32px; width:72px;" onClick="window.location.href='<?php echo base_url().'admin/Desktop_page_single_product/addnewsection_desktop_signle_product' ?>'" >
					...
					<div class="form_view">
						<h3>Add New Section Of Single Product Page</h3>
							<div width="100%">
                            		 <!----------------------Main table start------------------------>
                            <table>
                            <tr>
                            <td>
                            	...
                            	<table>
                                <tr>
                                	<td style="float:right;"><input type="checkbox" id="all_categories" name="all_categories" value="catid" onClick="apply_cat(this)"></td>
                                    <td>Global Products<sup></sup></td>                                    
                                </tr>
                                <tr>
                                    <td> <div id="lbl_catglink">Third Categories Link <sup>*</sup> </div></td>
                                    <td>
                                        <div id="hide_cat">
                                        <select name="menu_cat[]" data-placeholder="Choose Category Links"  
                                        class="chosen-select" style="width:500px" id="catid" multiple tabindex="4">
...
function apply_cat(e){
		if( $('input[name=all_categories]').is(':checked') ){
			...
			$('#lbl_catglink').css('display','none');
		}
		else
		{
  			$('#hide_cat').css('display','block');
			$('#lbl_catglink').css('display','block');
		}
