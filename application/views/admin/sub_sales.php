<ul class="top-menu">
    <?php if ($this->rbac->has_role('ADMIN')) { ?>
        <li class="<?php
        if ($this->uri->segment(2) == "sales" && $this->uri->segment(3) != "tax") {
            echo "selected";
        }
        ?>"><a href="<?php echo base_url(); ?>admin/sales">Orders</a></li>
            <?php /* ?><li><a href="<?php echo base_url(); ?>admin/sales/invoice">Invoices</a></li><?php */ ?>
        <li class="<?php
        if ($this->uri->segment(2) == "track_orders") {
            echo "selected";
        }
        ?>"><a href="#">Track Orders</a>
            <ul>
                <li><a href="<?php echo base_url(); ?>admin/track_orders">  In Transist</a> </li>
                <li><a href="<?php echo base_url(); ?>admin/track_orders/delivered_orders_tracking"> Delivered </a></li>     
            </ul>   
        </li>
        <li class="<?php
        if ($this->uri->segment(2) == "returned_orders") {
            echo "selected";
        }
        ?>"><a href="#">Returns</a>    
            <ul>
                <li><a href="<?php echo base_url(); ?>admin/returned_orders/return_in_progress"> In Progress</a> </li>
        ...
        ?>"><a href="<?php echo base_url(); ?>admin/sales/tax">Tax</a></li>
        ...
        foreach ($sub_query->result() as $rs) {
            ...
            <?php if ($rs->sub_tab_name == 'orders') { ?>        
                <li>	<a href="<?php echo base_url(); ?>admin/sales">Orders</a></li>
            <?php } ?>
            ...
            <?php if ($rs->sub_tab_name == 'tax') { ?>
                <li>	<a href="<?php echo base_url(); ?>admin/sales/tax">Tax</a></li>
            <?php } ?>

            <?php /* ?><?php if($rs->sub_tab_name=='credit_memos'){ ?>
