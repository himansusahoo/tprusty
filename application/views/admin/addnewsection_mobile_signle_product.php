...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/mobile_single_product_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/Page_single_product/addpage_single_productdata',$attributes);
					?>
					...
					<div class="row content-header">
                        ...
                        <div class="col-md-4 show_report">
                         ...
                         <button type="button" id="section_submit" class='all_buttons' style="background-color:#C03;float:right; font-weight:bold; height:32px; width:72px;" onClick="window.location.href='<?php echo base_url().'admin/page_catlog/addnewcatlog_formobilehomepage' ?>'" >
