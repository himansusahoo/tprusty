...
<div id="content">
 ...
 <div class="row content-header">
				<h3 style="margin-top:0px;">Bulk Products Upload Log</h3>
   
   
             <div class="exist_prod_new_list" align="right"><button type="button" onclick="window.location.href='<?php echo base_url(). 'admin/upload_bulkproduct/bulkproductupload_forseller/'.$seller_id ?>' ">Bulk Products Upload &nbsp;<i class="fa fa-upload" aria-hidden="true"></i>
</button>  </div>
</div>
		<!-------------------------------------------Listing start--------------------------------------------------------------------->
