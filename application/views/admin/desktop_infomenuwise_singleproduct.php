...
<table class="table table-bordered table-hover">
						...
						<select id="sec_status" name="sec_status" class="text2" style="width:200px; height:30px;" >
                            ...
                            <!--Data Display from page section table start-->                            	
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/product_vertical_section.png'; ?>" >									
                                   <?php } ?>
                                    <?php if($res_secinfo['sec_type']=='Video') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/video.png'; ?>" >								
                                   <?php } ?>
                                   
                                    <?php if($res_secinfo['sec_type']=='Product') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/product.png'; ?>" >								
                                   <?php } ?>
                                   
                                   <?php if($res_secinfo['sec_type']=='Rich Text Editor') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/Rich_texteditor.png'; ?>" >								
                                   <?php } ?>
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/'.$qr->row()->srcshot_imgname; ?>" >									<?php } ?>
                                   ...
                                   <?php } ?>
                                    	...
                                    	<td>
											<?php if($sort_i>1) {?>
												<img src='<?php echo base_url().'images/icon_finder/1495193298_Stock Index Up.ico' ?>' style="width:25px;height:29px;cursor:pointer;" onClick="singleprodsortby_section_upajx(<?=$res_secinfo['pgsection_sqlid']?>) " > &nbsp;  
												&nbsp;
												<span><a style="cursor: pointer; color:#333" onClick="singleprodsortby_section_upajx(<?=$res_secinfo['pgsection_sqlid']?>) ">Up</a></span>
												<span style="float:right;"><a class="fa fa-angle-double-up" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Top" onClick="singleprodsortby_section_totopajx(<?=$res_secinfo['pgsection_sqlid']?>) "> </a></span>
											<?php } ?><br>
                                    		<?php if($sort_i!=$sec_ctr){  ?>
												<img src='<?php echo base_url().'images/icon_finder/1495193373_Stock Index Down.ico' ?>' style="width:25px;height:29px;cursor:pointer;" onClick="singleprodsortby_section_downajx('<?=$res_secinfo['pgsection_sqlid']?>')" >
												<span><a style="cursor: pointer; color:#333" onClick="singleprodsortby_section_downajx('<?=$res_secinfo['pgsection_sqlid']?>')">Down</a></span>
												<span style="float:right;"><a class="fa fa-angle-double-down" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Buttom" onClick="singleprodsortby_section_todownajx('<?=$res_secinfo['pgsection_sqlid']?>')"> </a></span>
                                    		<?php } ?>
                                    	</td>
										<td>
                                        <a href="<?php echo base_url().'admin/Desktop_page_single_product/edit_desktop_singleproduct_section/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">
                                        <img src='<?php echo base_url().'images/icon_finder/1495194794_edit-notes.ico' ?>' style="width:33px;height:29px;cursor:pointer;"  >
                                        </a>
										&nbsp;
										<span><a style="cursor: pointer; color:#333;" href="<?php echo base_url().'admin/Desktop_page_single_product/edit_desktop_singleproduct_section/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">Edit </a></span><br>
