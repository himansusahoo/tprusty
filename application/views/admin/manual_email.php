        ...
        <form method="POST" action="<?php echo base_url(); ?>admin/sellers/manual_email_save" >                 
             ...
             <table border="0" cellspacing="0" cellpadding="0" style="width:100%; background-color: #ffffff;" align="center" class="container">
                            ...
                            <tr>
                                ...
                                <td height="25" align="center" class="ftr-nav">
                                    <blink><img onclick="window.location.href = 'https://play.google.com/store/apps/details?id=moonboy.online.shopping.india'" src="https://www.moonboy.in/images/pagedesign_image/trfl40mfnwb8cr620170921175530.jpg" style="width: 100%;margin: 1px 0px;"/></blink>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                        <tr>
                                            ...
                                            <td height="25" align="center" class="ftr-nav">
                                                ...
                                                <a href="https://www.moonboy.in/seller/seller" class="f-nav" target="blank_">Seller Login</a>
                                            </td>
                                        </tr>
            ...
            <center>
                ...
                <select name="from_id" id="from_id">
                    ...
                    <option selected value="seller@moonboy.in">seller@moonboy.in</option>
                    <option value="noreply@moonboy.in">noreply@moonboy.in</option>
                    <option value="support@moonboy.in">support@moonboy.in</option>
