...
function remove_menulink(pgsection_sqlid,menu_id)
{
	...
	if(conf){
		$('#loader_div').css('display','block');
			$.ajax({
				method:"POST",
				url:"<?php echo base_url().'admin/Desktop_page_single_product/remove_categorymenulink' ?>",
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/desktop_single_product_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/Desktop_page_single_product/update_single_product_sectiondata');
					?>
						...
						<h3>Edit Section Of Single Product Page</h3>
                            ...
                            <tr>
								...
								<tr>
                                    ...
                                    <label id="lbl_section_type" style="font-size:18px;"><?=$sec_info->row()->sec_type?> </label>
                                    	<select name="section_type" id="section_type" class="text2" style="display:none">
											...
											<?php /*<option value="Sponsored Product" <?php if($sec_info->row()->sec_type=='Sponsored Product'){echo 'selected';} ?>>Sponsored Product</option><?php */ ?>
                                ...
                                <?php
									...
									$img_size=$this->db->query("SELECT * FROM pagedesign_imagesize WHERE display_type='desktop' AND page_nm='single product' AND culumns_count='$clmn_conunt' ");?>
                            ...
                            <?php } ?>                
                                ...
                                <tr>
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/desktop/desktop_single_product/product_product_clmn2_300x400.png'; ?>" >								
                                   <?php } ?>
						   ...
						   $qr_clmnid=$this->db->query("SELECT * FROM desktopsite_columninfo WHERE page_id='4' AND sec_id='$sec_idclmn'  ");
...
function remove_img(i,j,img_sqlid)
{
	...
	$.ajax({
					method:"POST",
					url:"<?php echo base_url(); ?>admin/Desktop_page_single_product/remove_imagedata",
...
function remove_csvfile(i,j,img_sqlid,cvsfilenm)
{
	...
	if(conf)
	{
		...
		$.ajax({
			method:"POST",
			url:"<?php echo base_url(); ?>admin/Desktop_page_single_product/remove_csvdata",
