...
<div id="content">    
    ...
    <?php
    $qr_prcess = $this->db->query("SELECT uncategories FROM product_process_status WHERE status_id='1'")->row();
    $prcs_sts='';
    if(isset($qr_prcess->uncategories)){
        $prcs_sts = $qr_prcess->uncategories;
    }    
    ?>	
