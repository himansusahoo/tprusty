...
//	}
 ...
 <script>
  ...
  function catg_delete(category_id)
  {
	...
	<div id="content">    
		<div class="top-bar">
         ...
         <?php $qr_prcess=$this->db->query("SELECT uncategories FROM product_process_status WHERE status_id='1'  "); 
  ...
  <?php foreach($data2->result() as $rows){ ?> <!--level-1 --> 
    <li id="category_li">
      <input id="subcategory_id"  type="radio" name="subcategory_id" value="<?php echo $rows->category_id; ?> " onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rows->category_id; ?>'" <?php if($rows->category_id==$catg_info->category_id){ echo "checked" ;  }?>   />
      ...
      <?php $qr=$this->db->query("select * from category_indexing where parent_id='$rows->category_id' "); 
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs->category_id; ?>'" <?php if($rs->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs1->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs1->category_id; ?>'" <?php if($rs1->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs2->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs2->category_id; ?>'" <?php if($rs2->category_id==$catg_info->category_id){ echo "checked" ;  }?>/>
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs3->category_id; ?>"   onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs3->category_id; ?>'" <?php if($rs3->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs4->category_id; ?>"   onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs4->category_id; ?>'" <?php if($rs4->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs5->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs5->category_id; ?>'" <?php if($rs5->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs6->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs6->category_id; ?>'" <?php if($rs6->category_id==$catg_info->category_id){ echo "checked" ;  }?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs7->category_id; ?>"  onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs7->category_id; ?>'" <?php if($rs7->category_id==$catg_info->category_id){ echo "checked" ;  }?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs8->category_id; ?>" onChange="window.location.href='<?php echo base_url(); ?>admin/catalog/add_subcategory/<?php echo $rs8->category_id; ?>'" <?php if($rs8->category_id==$catg_info->category_id){ echo "checked" ;  }?> />
