...
*/
								...
								//$objPHPExcel->getActiveSheet()->SetCellValue('C'.$exist_rowcount, $str_qcfailedreason);
								//$objPHPExcel->getActiveSheet()->SetCellValue('D'.$exist_rowcount, 'Not Edited');
								$objPHPExcel->getActiveSheet()->SetCellValue('D'.$exist_rowcount, @$res_existproduct->product_id);															
								$objPHPExcel->getActiveSheet()->SetCellValue('E'.$exist_rowcount, @$res_existproduct->sku);
								
								/*$objPHPExcel->getActiveSheet()->SetCellValue('C'.$exist_rowcount, @$res_existproduct->name);								
								$objPHPExcel->getActiveSheet()->SetCellValue('D'.$exist_rowcount, @$res_existproduct->description);*/
								
								$objPHPExcel->getActiveSheet()->SetCellValue('F'.$exist_rowcount, @$res_existproduct->mrp);
								$objPHPExcel->getActiveSheet()->SetCellValue('G'.$exist_rowcount, @$res_existproduct->price);
								$objPHPExcel->getActiveSheet()->SetCellValue('H'.$exist_rowcount, @$res_existproduct->special_price);
								$objPHPExcel->getActiveSheet()->SetCellValue('I'.$exist_rowcount, @$res_existproduct->special_pric_from_dt);
								$objPHPExcel->getActiveSheet()->SetCellValue('J'.$exist_rowcount, @$res_existproduct->special_pric_to_dt);
								$objPHPExcel->getActiveSheet()->SetCellValue('K'.$exist_rowcount, @$res_existproduct->quantity);
								$objPHPExcel->getActiveSheet()->SetCellValue('L'.$exist_rowcount, @$res_existproduct->tax_amount);
								$objPHPExcel->getActiveSheet()->SetCellValue('M'.$exist_rowcount, @$res_existproduct->weight);
								
								$objPHPExcel->getActiveSheet()->SetCellValue('N'.$exist_rowcount, @$imgurl_1);
								$objPHPExcel->getActiveSheet()->SetCellValue('O'.$exist_rowcount, @$imgurl_2);
								$objPHPExcel->getActiveSheet()->SetCellValue('P'.$exist_rowcount, @$imgurl_3);
								$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$exist_rowcount, @$imgurl_4);
								$objPHPExcel->getActiveSheet()->SetCellValue('R'.$exist_rowcount, @$imgurl_5);
								
								if(@$res_existproduct->shipping_fee==0)
								{
								 $objPHPExcel->getActiveSheet()->SetCellValue('S'.$exist_rowcount, 'Free');
								}
								else
								{$objPHPExcel->getActiveSheet()->SetCellValue('S'.$exist_rowcount, 'Default');}
								
								$objPHPExcel->getActiveSheet()->SetCellValue('T'.$exist_rowcount, @$res_existproduct->shipping_fee_amount);
								$objPHPExcel->getActiveSheet()->SetCellValue('U'.$exist_rowcount, @$res_existproduct->status);
								...
								$objPHPExcel->getActiveSheet()->SetCellValue('V'.$exist_rowcount, @$res_existproduct->manufacture_country);
								/*$objPHPExcel->getActiveSheet()->SetCellValue('AA'.$exist_rowcount, @$res_existproduct->meta_title);
								$objPHPExcel->getActiveSheet()->SetCellValue('AB'.$exist_rowcount, @$res_existproduct->meta_keywords);
								$objPHPExcel->getActiveSheet()->SetCellValue('AC'.$exist_rowcount, @$res_existproduct->meta_desc);*/
