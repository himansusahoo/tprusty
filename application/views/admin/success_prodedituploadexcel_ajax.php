...
$qr_uplod=$this->db->query("SELECT uploadprod_sqlid,uploadprod_uid,qc_status from bulk_editedproductupload_log WHERE uploadprod_uid='$uploded_id' AND qc_status='Passed' AND editstatus='Edited' ");
