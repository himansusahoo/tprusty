...
header("Content-Disposition: attachment; filename=".preg_replace('#"#',"_",preg_replace('#/#',"_",str_replace(',','_',str_replace('&','',str_replace(' ','_',strtolower($catgnm))))))."_".$rand_string."_".$dt_rec."_existingproduct.xls"); 
