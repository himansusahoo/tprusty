...
<script>
function loadPriceNinvntryInfo(product_id,sku){
	$.ajax({
		url:'<?php echo base_url(); ?>admin/catalog/load_exiting_approved_product_prc_n_invtry_info',
		method:'post',
		...
		success:function(data){
			...
			<div id="content">    
                ...
                <?php echo form_open_multipart('admin/catalog/update_approved_existing_product_data');?>
          ...
          <div class="valid_msg_dv"></div>
			...
			<ul class="nav nav-tabs tabs-horiz">
				...
				<!--<li id="li_tab3" onClick="loadPriceNinvntryInfo('<?//=$edit_product_details[0]->product_id;?>','<?//=$edit_product_details[0]->sku;?>');"><a data-toggle="tab" href="#tab3">Inventory & Prices</a></li>-->
			...
			<div class="tab-content form_view">                
				...
				<div id="tab3" class="tab-pane fade load_price_info">
					...
					<table>
                        ...
                        <tr style="display:none;">
                        	<td> GST <sup>*</sup> </td>
                            <td width="175px"><input type="text" name="vat_cst" id="vat_cst" value="0" class="seller_input"></td>
                            <td></td>
                        </tr>
                        <?php }else{ ?>
                        <tr>
                        ...
                        <tr style="display:none;">
                            ...
                            <td>
                            	<select name="shipping_typ" id="shipping_typ" class="text" style="width:200px;">
                        ...
                        <tr style="display:none;">
                              <td>Qty<sup>*</sup></td>
                              <td><input type="text" class="text" name="qty" id="qty" value="0"></td>
                        </tr>
                        <?php }else{?>
                        <tr>
                              <td>Qty<sup>*</sup></td>
                ...
                </div> <!--- Price & inventory information load in ajax --->
