...
<div id="content">  
    ...
    <div class="main-content">
		...
		<?php if(@$data==true){ ?><div align="center" style="color:#0C6"> <?php  echo $data ?> </div> <?php } ?>
          ...
          <form id="save_catgory_form" method="post" action="<?php echo base_url().'admin/Super_admin/add_newmobilemenu' ?>" enctype="multipart/form-data">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                   ...
                                   <div id="imag_div" align="center">
                                        ...
                                        <legend style="background-color:#e5e7e9;border: 1px solid; border-radius: 25px;">Upload Menu Image</legend>                                         <div align="center" style="color:#F00; font-weight:bold; background-color:#FFF;"> 
											Menu Icon Size : 145x145 Pixel
                                            <br> 
											Menu Image Size : 150x216 Pixel
                                            </div> 
...
function valid_imgdimensiion(width,height) {
    var menu_lvl= $('#menu_have_Parent').val();
