			 ...
			 <!-- @end top-bar  -->
                ...
                <?php if($this->session->flashdata('flshmsg')){ ?>	<div id="successfully_verify" style="color:#0C0;" align="center">
					...
					<div class="row gray_bg">
						...
						<img src="<?php //echo base_url().'images/success_icon.png' ?>">&nbsp<?php //echo $this->session->flashdata('msgcod_wtchrg'); ?></div> <?php //} ?>									<button id="product_submit" class='seller_buttons' style="background-color:#666;float:right;" onclick="window.location.href='<?php echo base_url().'admin/page_setup/addnewsection_formobilehomepage'; ?>'" > 
						...
						<img src="<?php //echo base_url().'images/success_icon.png' ?>">&nbsp<?php //echo $this->session->flashdata('msgcod_wtchrg'); ?></div> <?php //} ?>		
                            <a id="product_submit" class='seller_buttons add-new-sec' style="background-color:#666;float:right;" href="<?php echo base_url().'admin/page_setup/addnewsection_formobilehomepage'; ?>" target="_blank">
						...
						<select id="sec_status" name="sec_status"  class="text2" style="width:200px; height:30px;" >
                            ...
                            <!--Data Display from page section table start-->
								...
								?>
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/mobile/mobile_homepage/product_vertical_section.png'; ?>" >									
                                   <?php } ?>
                                    <?php if($res_secinfo['sec_type']=='Video') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/mobile/mobile_homepage/video.png'; ?>" >								
                                   <?php } ?>
                                   
                                    <?php if($res_secinfo['sec_type']=='Product') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/mobile/mobile_homepage/proudct.png'; ?>" >								
                                   <?php } ?>
                                   
                                   <?php if($res_secinfo['sec_type']=='Rich Text Editor') {?>
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/mobile/mobile_homepage/Rich_texteditor.png'; ?>" >								
                                   <?php } ?>
                                   ...
                                   <img style="float:left;" src="<?php echo base_url().'images/admin/mobile/mobile_homepage/'.$qr->row()->srcshot_imgname; ?>" >									<?php } ?>
                                   ...
                                   <?php } ?>
                                    ...
                                    <?php if($sort_i>1) {?>
                                    <img src='<?php echo base_url().'images/icon_finder/1495193298_Stock Index Up.ico' ?>' style="width:25px;height:29px;cursor:pointer;" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_up/'.$res_secinfo['pgsection_sqlid'] ?>' " > &nbsp;
									<span><a style="cursor: pointer; color:#333" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_up/'.$res_secinfo['pgsection_sqlid'] ?>' ">Up </a></span>
									<span style="float:right;"><a class="fa fa-angle-double-up" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Top" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_movetop/'.$res_secinfo['pgsection_sqlid'] ?>' "></a></span>
									<?php } ?><br>
                                    <?php if($sort_i!=$sec_ctr){  ?>
                                    <img src='<?php echo base_url().'images/icon_finder/1495193373_Stock Index Down.ico' ?>' style="width:25px;height:29px;cursor:pointer;" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_down/'.$res_secinfo['pgsection_sqlid'] ?>' " >
									<span><a style="cursor: pointer; color:#333" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_down/'.$res_secinfo['pgsection_sqlid'] ?>' ">Down</a></span>&nbsp;&nbsp;
									<span style="float:right;"><a class="fa fa-angle-double-down" style="cursor: pointer; color:#333; font-size:20px;" title="Move To Buttom" onClick="window.location.href='<?php echo base_url().'admin/page_setup/hompagesortby_section_movedown/'.$res_secinfo['pgsection_sqlid'] ?>' "> </a></span>
                                    <?php } ?>
                                    <?php } ?>
                                    </td>
                                    <td>
                                     <a href="<?php echo base_url().'admin/page_setup/edit_mobilehomepagesection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">
                                        <img src='<?php echo base_url().'images/icon_finder/1495194794_edit-notes.ico' ?>' style="width:30px;height:25px;cursor:pointer;" >
                            		&nbsp;</a>
									<span><a style="cursor: pointer; color:#333;" href="<?php echo base_url().'admin/page_setup/edit_mobilehomepagesection/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">Edit </a></span><br>
...
function valid_remove(sec_sqlid)
{
	...
	if(conf)
	{
		window.location.href='<?php echo base_url().'admin/page_setup/remove_mobilehomepagesection/'?>'+sec_sqlid ;
	}
}
	...
	if($('#sec_status').val()=="")
		...
		else
		{
			...
			$('#loader_div').css('display','block');
				$.ajax({
					method:"POST",
					url:"<?php echo base_url(); ?>admin/page_setup/change_sec_status",
