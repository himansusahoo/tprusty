...
<div id="content">
 ...
 <div class="row content-header">
				<h3 style="margin-top:0px;">Bulk Existing Products Upload Log</h3>
   
   
             <div class="exist_prod_new_list" align="right"><button type="button" onclick="window.location.href='<?php echo base_url(). 'admin/Upload_bulk_existingproduct/bulk_existingproductupload_panel/'.$seller_id ?>' " style="width:230px;">Bulk Existing Products Upload &nbsp;<i class="fa fa-upload" aria-hidden="true"></i>
</button>  </div>
</div>
		<!-------------------------------------------Listing start--------------------------------------------------------------------->
                       ...
                       <form action="<?php echo base_url().'admin/sales/filter_order' ?>" method="post" >
                            ...
                            <?php if($uploadlist->num_rows()>0){ 
								...
								{	
									...
									$prod_query=$this->db->query("SELECT uploadprod_sqlid,uploadprod_uid,upload_status FROM bulk_existingproductupload_log WHERE uploadprod_uid='$upload_id' AND master_productid!=''  ");
                            ...
                            <td><a href="<?php echo base_url().'bulk_existingproductexcel/'.$res_uploadlist['excelfile_name']?>"><div class="wrapper"><img src="<?php echo base_url().'images/Excel.png' ?>" width="30" height="30"  title="<?=$res_uploadlist['excelfile_name']; ?>"/><?=$res_uploadlist['excelfile_name']; ?><div class="tooltip">Click to download the file as you have original uploaded</div></div></a><!--<i style="font-size:16px;" class="fa fa-eye"></i>--></td>
                            <td><?=$pending?> </td>                           
                            <td><?=$failed?> </td> 
                            <td><?=$upload?> </td>
                            <td><?=$tot?> </td>
