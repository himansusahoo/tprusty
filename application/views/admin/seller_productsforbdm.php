...
.Zebra_DatePicker{ z-index:999999 !important;}
		...
		<div id="content">
			...
			<div class="main-content">
				<div class="row content-header">
                    ...
                    <?php echo $buss_name->row()->business_name; ?></h4>
					<div class="a-center">
					<?php
  ...
  <?php //} ?>-->  
               <!--<?php// //if($this->session->flashdata('seller_products')){ ?>	<div style="color:#0C0;">
                ...
                <form action="<?php echo base_url().'admin/sellers/filter_sellprodforbdm/'.$seller_id; ?>" method="post" >
				...
				<div>                                 
					...
					<table class="table table-bordered table-hover">
                        ...
                        <?php
                            ...
                            <td> <a href="<?php echo base_url().preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($product->name)))).'/'.$product->product_id.'/'.$product->sku;?>" target="_blank"> <?php echo $product->sku; ?> </a></td>
							<td> <a href="<?php echo base_url().preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($product->name)))).'/'.$product->product_id.'/'.$product->sku;?>" target="_blank"> <?php echo $product->name; ?></a> </td>
                           ...
                           <?php /*?> <td><a href="<?php echo base_url(); ?>admin/catalog/product_edit/<?=$product->product_id;?>/<?= base64_encode($this->encrypt->encode($product->sku));?>" target="_blank">Edit</a>
