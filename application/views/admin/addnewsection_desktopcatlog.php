...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/desktop_catlog_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/desktop_page_catlog/add_pagecatlogdata',$attributes);
					?>
                	<!--<form onSubmit="return membershipInfo()">-->
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Section Of Catalog Page</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
                        <div class="col-md-4 show_report">
                        
                         <button type="button" id="section_submit" class='all_buttons' style="background-color:#C03;float:right; font-weight:bold; height:32px; width:72px;" onClick="window.location.href='<?php echo base_url().'admin/desktop_page_catlog/addnewsection_desktopcatlog' ?>'" >
					...
					<div class="form_view">
						<h3>Add New Section Of Catalog Page</h3>
							<div width="100%">
                            		 <!----------------------Main table start------------------------>
                            <table>
                            <tr>
                            <td>
                            	...
                            	<table>
                                <tr>
                                    <td> Third Level Menu Link <sup>*</sup> </td>
                                    <td>
