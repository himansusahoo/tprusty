...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/Page_search/select_imagesize",
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/Page_search/select_screeshot",
