...
function populate_sectiondatatype(sec_type)
{
	...
	else
	{
			...
			if(sec_type=='Banner' || sec_type=='Slider' || sec_type=='Video' || sec_type=='Grouped Banner')
			{
			...
			else if(sec_type=='Carousel' || sec_type=='Featured Box')
			{
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();
			...
			else if(sec_type=='Product' || sec_type=='Prodcts Vertical section' || sec_type=='Product Catalog' )
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
		method:"POST",
		url:"<?php echo base_url(); ?>admin/Page_catlog/select_screeshot",
...
{
	if($('#section_type').val()!='Video' && $('#section_type').val()!='Product' && $('#section_type').val()!='Prodcts Vertical section' && $('#section_type').val()!='Rich Text Editor' && $('#section_type').val()!='Featured Box' && $('#section_type').val()!='Product Catalog')
	{
