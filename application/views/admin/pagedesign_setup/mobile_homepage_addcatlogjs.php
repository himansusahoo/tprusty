...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/Page_catlog/select_imagesize",
						data:{clmn_count:clmn_count},
