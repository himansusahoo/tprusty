...
function add_columninfo()
{
	...
	else if($('#section_type').val()=='Banner' && $('#sectiondata_type').val()=='Banner' && $('#col_num').val()=='4' && $('#slctimage_size').val()=='263x166')
		{
		 for (var i = 1; i <= num_col; i++) {
...
function valid_img_slider_banner(width,height,i,j) {
	...
	var spefic_size = validate_img_size.substr(6, 7);
	//alert(spefic_size);
	var spefic_size1 = validate_img_size.substr(20, 25);
	//alert(spefic_size);
	//alert(spefic_size1);
...
function valid_img_carousal_banner(width,height,i,j) {
	...
	var spefic_sizebann = validate_img_sizebann.substr(6, 6);
	//alert(spefic_size);
	var spefic_sizebann1 = validate_img_sizebann.substr(19, 21);
	//alert(spefic_size);
	//alert(spefic_size1);
	//var imgdmns_defnd=$('#slctimage_size').val();	
...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
			method:"POST",
			url:"<?php echo base_url(); ?>admin/Desktop_page_catlog/select_imagesize",
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/Desktop_page_catlog/select_screeshot",
