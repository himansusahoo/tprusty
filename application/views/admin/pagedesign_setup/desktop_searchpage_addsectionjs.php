...
function populate_sectiondatatype(sec_type)
{
	if(sec_type=='Rich Text Editor')
	{
		...
		$('#div_screenshot').append($("<img></img>").attr("src","<?php echo base_url() ?>/images/admin/desktop/desktop_searchpage/Rich_texteditor.png"));
	...
	if(sec_type=='Catagory' || sec_type=='Popular Product' || sec_type=='Category Product')
	{
		...
		$('#div_screenshot').append($("<img></img>").attr("src","<?php echo base_url() ?>/images/admin/desktop/desktop_searchpage/product.png"));
		$('#screeshotprocess_div').css('display','none');
	}
	else
	{
...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
			method:"POST",
			url:"<?php echo base_url(); ?>admin/desktop_page_search/select_imagesize",
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/desktop_page_search/select_screeshot",
