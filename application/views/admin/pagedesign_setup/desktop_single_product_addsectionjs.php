...
function populate_sectiondatatype(sec_type)
{
	if(sec_type=='Rich Text Editor')
	{
		...
		$('#div_screenshot').append($("<img></img>").attr("src","<?php echo base_url() ?>/images/admin/desktop/desktop_single_product/Rich_texteditor.png"));
	...
	else
	{
			...
			else if(sec_type=='Carousel' || sec_type=='Sponsored Product')
			{
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();
...
function select_nofcolumn()
{
	...
	if($('#section_type').val()=='Sponsored Product' && $('#sectiondata_type').val()=='Banner')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
		method:"POST",
		url:"<?php echo base_url(); ?>admin/Desktop_page_single_product/select_screeshot",
...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
			method:"POST",
			url:"<?php echo base_url(); ?>admin/Desktop_page_single_product/select_imagesize",
