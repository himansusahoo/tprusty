...
function add_columninfo()
{
	...
	if($('#section_type').val()!='Video' && $('#section_type').val()!='Product' && $('#section_type').val()!='Prodcts Vertical section' && $('#section_type').val()!='Rich Text Editor' && $('#section_type').val()!='Product Grid View' && $('#section_type').val()!='Banner' && $('#section_type').val()!='Video with Product Carousel')
		{
		 for (var i = 1; i <= num_col; i++) {
           $('#columninfo_div').append('<fieldset id="fld_secion_'+i+'"><legend style="background-color:#a3e4d7;" id="column_legend'+i+'">Column '+i+' &nbsp;</legend><table><tr><td>Column Background Color</td><td align="left"><input type="color" class="text2" name="clmn_bgcolor[]" id="clmn_bgcolor'+i+'" style="width:200px; height:40px;"></td></tr><tr><td>Column Status</td><td align="left"><select class="text2" name="clmn_sts[]" id="clmn_sts'+i+'" style="width:200px; height:40px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td></tr><tr><td>Column Type</td><td><select class="text2" name="clmn_type[]" id="clmn_type'+i+'" style="width:200px; height:40px;"><option value="">--select--</option><option value="url">URL</option><option value="sku">SKU</option></select></td></tr><tr><td style="width:20%;"> Memo </td><td><textarea class="text2" name="clmn_memo[]" id="clmn_memo'+i+'"></textarea></td></tr><tr><td colspan="2" align="center"><fieldset id="fld_culmn'+i+'" style="background-color:#a9dfbf;"><legend style="background-color:#9CF;">Image Upload With Link</legend><div class="alert" id="alrt'+i+'" style="display:none;"><span class="closebtn" style="display:none;">&times;</span><strong>!</strong></div><button style="float:right;" type="button" id="add_sectioncolumninfo" class="seller_buttons" onClick="add_image('+i+')" ><i class="fa fa-file-image-o" aria-hidden="true"></i> &nbsp;ADD Image </button><table id="img_tbl'+i+'" class="table table-bordered table-hover" style="background-color:#FFF;"><tr style="background-color:#f5b041;"><th width="10%">Image</th><th width="5%">Link Type</th><th width="15%">SKU / URL</th><th width="5%">Image Status</th><th width="5%">From date</th><th width="5%">To date</th><th width="10%">Memo</th><th width="5%">Action</th></tr><tr id="tblrow_tbl'+i+j+'"><td><input type="file" style="width:192px;" id="imgInp'+i+j+'" name="userfile'+i+'[]'+'"  onChange="preview_img(this,'+i+','+j+')" ><img id="imgprvw'+i+j+'" src="#" alt="your image" style="width:95px;height:80px;display:none;" /></br><span id="removimage'+i+j+'" style="color:red;display:none;cursor:pointer;" onClick="img_remove('+i+','+j+')">Remove Image</span><fieldset id="imgelbl'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Image Label</legend><span class="textarea_val'+i+j+'" style="width:20%; float:right; margin-top: -52px;    padding: 16px; display: inline-block;"></span><textarea name="imglab_txtara'+i+'[]'+'" id="imglab_txtara'+i+j+'" class="imglab_txtara'+i+j+'" onKeyUp="onkeuup('+i+j+')" maxlength="5" style="width:127px;" placeholder="Enter Image Label"></textarea></fieldset></td><td><select onChange="display_urlvisible('+i+','+j+')" style="width:80px;" class="text2" name="img_skuorurl'+i+'[]'+'" id="img_skuorurl'+i+j+'" style="width:80px; height:40px;"><option value="sku">SKU</option><option value="url">URL</option><option value="nolink">No Link</option></select></br></br><fieldset id="displayurlfldset'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Display URL</legend><textarea name="dispaly_url'+i+'[]'+'" id="dispaly_url'+i+j+'"  style="width:127px;" placeholder="Enter Display URL"></textarea></fieldset></br><fieldset id="sortbyinfo'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Sort By</legend><select style="width:150px; height:40px;" class="text2" name="sku_sortby'+i+'[]'+'" id="sku_sortby'+i+j+'"><option value="as_per_sku">As Per sku</option><option value="random">Random</option><option value="prc_asc">Price High To Low</option><option value="pric_dec">Price Low To High</option></select></fieldset></td><td><textarea id="imglinkkskuorurl'+i+j+'" name="imglinkkskuorurl'+i+'[]'+'" style="width:192px; height:80px;"></textarea><br><div id="orExcelInp'+i+j+'" style="font-weight:bold;text-align:center;" align="center">OR</div><br><input style="width:192px;" type="file" onChange="valid_csvfileextension(this,'+i+','+j+')" id="ExcelInp'+i+j+'" name="userfile_excel'+i+'[]'+'"></td><td><select class="text2" name="img_sts'+i+'[]'+'" id="img_sts'+i+j+'" style="width:80px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td><td><input type="date" id="from_dt'+i+j+'" style="width:150px;" name="from_dt'+i+'[]'+'"></td><td><input type="date" id="to_date'+i+j+'" name="to_date'+i+'[]'+'" style="width:150px;" ></td><td><textarea style="width:116px; height:80px;" name="img_memo'+i+'[]'+'" id="img_memo'+i+j+'" ></textarea></td><td><i style="color:#FF0000;cursor:pointer;" onClick="remove_imgtblrow('+i+','+j+')" class="fa fa-times" aria-hidden="true"></i></td></tr></table></fieldset></td></tr></table></fieldset>'); 
        }
	}
	else if($('#section_type').val()=='Banner' && $('#sectiondata_type').val()=='Banner' && $('#col_num').val()=='4' && $('#slctimage_size').val()=='333x210')
		{
		 for (var i = 1; i <= num_col; i++) {
	...
	else if($('#section_type').val()=='Video with Product Carousel' && $('#sectiondata_type').val()=='Video With Product' && $('#col_num').val()=='2' && $('#slctimage_size').val()=='100x200')
		{
		 for (var i = 1; i <= num_col; i++) {
           $('#columninfo_div').append('<fieldset id="fld_secion_'+i+'"><legend style="background-color:#a3e4d7;" id="column_legend'+i+'">Column '+i+' &nbsp;</legend><table><tr><td>Column Background Color</td><td align="left"><input type="color" class="text2" name="clmn_bgcolor[]" id="clmn_bgcolor'+i+'" style="width:200px; height:40px;"></td></tr><tr><td>Column Status</td><td align="left"><select class="text2" name="clmn_sts[]" id="clmn_sts'+i+'" style="width:200px; height:40px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td></tr><tr><td>Column Type</td><td><select class="text2" name="clmn_type[]" id="clmn_type'+i+'" style="width:200px; height:40px;"><option value="">--select--</option><option value="url">URL</option><option value="sku">SKU</option></select></td></tr><tr><td style="width:20%;"> Memo </td><td><textarea class="text2" name="clmn_memo[]" id="clmn_memo'+i+'"></textarea></td></tr><tr><td colspan="2" align="center"><fieldset id="fld_culmn'+i+'" style="background-color:#a9dfbf;"><legend style="background-color:#9CF;">Image Upload With Link</legend><div class="alert" id="alrt'+i+'" style="display:none;"><span class="closebtn" style="display:none;">&times;</span><strong>!</strong></div><button style="float:right; display:none;" type="button" id="add_sectioncolumninfo" class="seller_buttons" onClick="add_image('+i+')" ><i class="fa fa-file-image-o" aria-hidden="true"></i> &nbsp;ADD Image </button><table id="img_tbl'+i+'" class="table table-bordered table-hover" style="background-color:#FFF;"><tr style="background-color:#f5b041;"><th width="10%">Image</th><th width="5%">Link Type</th><th width="15%">SKU / URL</th><th width="5%">Image Status</th><th width="5%">From date</th><th width="5%">To date</th><th width="10%">Memo</th><th width="5%">Action</th></tr><tr id="tblrow_tbl'+i+j+'"><td><input type="file" style="width:192px;" id="imgInp'+i+j+'" name="userfile'+i+'[]'+'"  onChange="preview_img(this,'+i+','+j+')" ><img id="imgprvw'+i+j+'" src="#" alt="your image" style="width:95px;height:80px;display:none;" /></br><span id="removimage'+i+j+'" style="color:red;display:none;cursor:pointer;" onClick="img_remove('+i+','+j+')">Remove Image</span><fieldset id="imgelbl'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Image Label</legend><span class="textarea_val'+i+j+'" style="width:20%; float:right; margin-top: -52px; padding: 16px; display: inline-block;"></span><textarea name="imglab_txtara'+i+'[]'+'" id="imglab_txtara'+i+j+'" class="imglab_txtara'+i+j+'" onKeyUp="onkeuup('+i+j+')" maxlength="8" style="width:127px;" placeholder="Enter Image Label"></textarea></fieldset></td><td><select onChange="display_urlvisible('+i+','+j+')" style="width:80px;" class="text2" name="img_skuorurl'+i+'[]'+'" id="img_skuorurl'+i+j+'" style="width:80px; height:40px;"><option value="sku">SKU</option><option value="url">URL</option><option value="nolink">No Link</option></select></br></br><fieldset id="displayurlfldset'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Display URL</legend><textarea name="dispaly_url'+i+'[]'+'" id="dispaly_url'+i+j+'"  style="width:127px;" placeholder="Enter Display URL"></textarea></fieldset></br><fieldset id="sortbyinfo'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Sort By</legend><select style="width:150px; height:40px;" class="text2" name="sku_sortby'+i+'[]'+'" id="sku_sortby'+i+j+'"><option value="as_per_sku">As Per sku</option><option value="random">Random</option><option value="prc_asc">Price High To Low</option><option value="pric_dec">Price Low To High</option></select></fieldset></td><td><textarea id="imglinkkskuorurl'+i+j+'" name="imglinkkskuorurl'+i+'[]'+'" style="width:192px; height:80px;"></textarea><br><div id="orExcelInp'+i+j+'" style="font-weight:bold;text-align:center;" align="center">OR</div><br><input style="width:192px;" type="file" onChange="valid_csvfileextension(this,'+i+','+j+')" id="ExcelInp'+i+j+'" name="userfile_excel'+i+'[]'+'"></td><td><select class="text2" name="img_sts'+i+'[]'+'" id="img_sts'+i+j+'" style="width:80px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td><td><input type="date" id="from_dt'+i+j+'" style="width:150px;" name="from_dt'+i+'[]'+'"></td><td><input type="date" id="to_date'+i+j+'" name="to_date'+i+'[]'+'" style="width:150px;" ></td><td><textarea style="width:116px; height:80px;" name="img_memo'+i+'[]'+'" id="img_memo'+i+j+'" ></textarea></td><td><i style="color:#FF0000;cursor:pointer;" onClick="remove_imgtblrow('+i+','+j+')" class="fa fa-times" aria-hidden="true"></i></td></tr></table></fieldset></td></tr></table></fieldset>'); 
        }
	...
	{var i = 1;
		$('#columninfo_div').append('<fieldset id="fld_secion_'+i+'"><legend style="background-color:#a3e4d7;" id="column_legend'+i+'">Column '+i+' &nbsp;</legend><table><tr><td>Column Background Color</td><td align="left"><input type="color" class="text2" name="clmn_bgcolor[]" id="clmn_bgcolor'+i+'" style="width:200px; height:40px;"></td></tr><tr><td>Column Status</td><td align="left"><select class="text2" name="clmn_sts[]" id="clmn_sts'+i+'" style="width:200px; height:40px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td></tr><tr><td>Column Type</td><td><select class="text2" name="clmn_type[]" id="clmn_type'+i+'" style="width:200px; height:40px;"><option value="">--select--</option><option value="url">URL</option><option value="sku">SKU</option></select></td></tr><tr><td style="width:20%;"> Memo </td><td><textarea class="text2" name="clmn_memo[]" id="clmn_memo'+i+'"></textarea></td></tr><tr><td colspan="2" align="center"><fieldset id="fld_culmn'+i+'" style="background-color:#a9dfbf;"><legend style="background-color:#9CF;">Image Upload With Link</legend><div class="alert" id="alrt'+i+'" style="display:none;"><span class="closebtn" style="display:none;">&times;</span><strong>!</strong></div><button style="float:right;display:none;" type="button" id="add_sectioncolumninfo" class="seller_buttons" onClick="add_image('+i+')" ><i class="fa fa-file-image-o" aria-hidden="true"></i> &nbsp;ADD Image </button><table id="img_tbl'+i+'" class="table table-bordered table-hover" style="background-color:#FFF;"><tr style="background-color:#f5b041;"><th width="10%">Image</th><th width="5%">Link Type</th><th width="15%">SKU / URL</th><th width="5%">Image Status</th><th width="5%">From date</th><th width="5%">To date</th><th width="10%">Memo</th><th width="5%">Action</th></tr><tr id="tblrow_tbl'+i+j+'"><td><input type="file" style="width:192px;" id="imgInp'+i+j+'" name="userfile'+i+'[]'+'"  onChange="preview_img(this,'+i+','+j+')" ><img id="imgprvw'+i+j+'" src="#" alt="your image" style="width:95px;height:80px;display:none;" /></br><span id="removimage'+i+j+'" style="color:red;display:none;cursor:pointer;" onClick="img_remove('+i+','+j+')">Remove Image</span><fieldset id="imgelbl'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Image Label</legend><span class="textarea_val'+i+j+'" style="width:20%; float:right; margin-top: -52px;    padding: 16px; display: inline-block;"></span><textarea name="imglab_txtara'+i+'[]'+'" id="imglab_txtara'+i+j+'" class="imglab_txtara'+i+j+'" onKeyUp="onkeuup('+i+j+')" maxlength="5"  style="width:127px;" placeholder="Enter Image Label"></textarea></fieldset></td><td><select onChange="display_urlvisible('+i+','+j+')" style="width:80px;" class="text2" name="img_skuorurl'+i+'[]'+'" id="img_skuorurl'+i+j+'" style="width:80px; height:40px;"><option value="sku">SKU</option><option value="url">URL</option><option value="nolink">No Link</option></select></br></br><fieldset id="displayurlfldset'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Display URL</legend><textarea name="dispaly_url'+i+'[]'+'" id="dispaly_url'+i+j+'"  style="width:127px;" placeholder="Enter Display URL"></textarea></fieldset></br><fieldset id="sortbyinfo'+i+j+'"><legend style="background-color:#CCC; font-size:13px; font-weight:bold;">Sort By</legend><select style="width:150px; height:40px;" class="text2" name="sku_sortby'+i+'[]'+'" id="sku_sortby'+i+j+'"><option value="as_per_sku">As Per sku</option><option value="random">Random</option><option value="prc_asc">Price High To Low</option><option value="pric_dec">Price Low To High</option></select></fieldset></td><td><textarea id="imglinkkskuorurl'+i+j+'" name="imglinkkskuorurl'+i+'[]'+'" style="width:192px; height:80px;"></textarea><br><div id="orExcelInp'+i+j+'" style="font-weight:bold;text-align:center;" align="center">OR</div><br><input onChange="valid_csvfileextension(this,'+i+','+j+')" type="file" style="width:192px;" id="ExcelInp'+i+j+'" name="userfile_excel'+i+'[]'+'"></td><td><select class="text2" name="img_sts'+i+'[]'+'" id="img_sts'+i+j+'" style="width:80px;"><option value="active">Active</option><option value="inactive">Inactive</option></select></td><td><input type="date" id="from_dt'+i+j+'" style="width:150px;" name="from_dt'+i+'[]'+'"></td><td><input type="date" id="to_date'+i+j+'" name="to_date'+i+'[]'+'" style="width:150px;" ></td><td><textarea style="width:116px; height:80px;" name="img_memo'+i+'[]'+'" id="img_memo'+i+j+'" ></textarea></td><td><i style="color:#FF0000;cursor:pointer;" onClick="remove_imgtblrow('+i+','+j+')" class="fa fa-times" aria-hidden="true"></i></td></tr></table></fieldset></td></tr></table></fieldset>');
...
var img = new Image();
 ...
 img.onload = function () {
		...
		var sec_validate_defnd=$('#section_type').val();
		
		if(sec_validate_defnd=='Vertical Carousal With Thin Banner'){
			
			valid_img_carousal_banner(width,height,i,j); //call function
			
		}
		else if(sec_validate_defnd=='Slider With Add Banner'){
			
			valid_img_slider_banner(width,height,i,j); //call function
...
function valid_img_slider_banner(width,height,i,j) {
	var validate_img_size=$('#slctimage_size').val();
	var spefic_size = validate_img_size.substr(6, 8);
	//alert(spefic_size);
	var spefic_size1 = validate_img_size.substr(21, 25);
	//alert(spefic_size);
	//alert(spefic_size1);
	//var imgdmns_defnd=$('#slctimage_size').val();	
	var image_dm=width+'x'+height;
	
	if($('#column_legend'+i).text()=='Column 1  '){
		//alert('hello');
		if(spefic_size!=image_dm)
	{	//alert('! Invalid Image. Required Size: '+imgdmns_defnd+' Pixel '  );
		$('#alrt'+i).text('! Invalid Image. Required Size: '+spefic_size+' Pixel ');
		$('#alrt'+i).css('display','block');
		 $('html, body').animate({
        'scrollTop' : $('#fld_secion_'+i).position().top
    });
	...
	if($('#column_legend'+i).text()=='Column 2  '){
		//alert('hii');
		if(spefic_size1!=image_dm)
			{	
				$('#alrt'+i).text('! Invalid Image. Required Size: '+spefic_size1+' Pixel ');
				$('#alrt'+i).css('display','block');
				$('html, body').animate({
				'scrollTop' : $('#fld_secion_'+i).position().top
				});
...
function valid_img_carousal_banner(width,height,i,j) {
	var validate_img_sizebann=$('#slctimage_size').val();
	var spefic_sizebann = validate_img_sizebann.substr(6, 7);
	//alert(spefic_size);
	var spefic_sizebann1 = validate_img_sizebann.substr(20, 21);
	//alert(spefic_size);
	//alert(spefic_size1);
	//var imgdmns_defnd=$('#slctimage_size').val();	
	var image_dmbann=width+'x'+height;
	
	if($('#column_legend'+i).text()=='Column 1  '){
		//alert('hello');
		if(spefic_sizebann!=image_dmbann)
	{	//alert('! Invalid Image. Required Size: '+imgdmns_defnd+' Pixel '  );
		$('#alrt'+i).text('! Invalid Image. Required Size: '+spefic_sizebann+' Pixel ');
		$('#alrt'+i).css('display','block');
		 $('html, body').animate({
        'scrollTop' : $('#fld_secion_'+i).position().top
    });
	...
	if($('#column_legend'+i).text()=='Column 2  '){
		//alert('hii');
		if(spefic_sizebann1!=image_dmbann)
			{	
				$('#alrt'+i).text('! Invalid Image. Required Size: '+spefic_sizebann1+' Pixel ');
				$('#alrt'+i).css('display','block');
				$('html, body').animate({
				'scrollTop' : $('#fld_secion_'+i).position().top
				});
...
function populate_sectiondatatype(sec_type)
{
	if(sec_type=='Rich Text Editor')
	{
		...
		$('#div_screenshot').append($("<img></img>").attr("src","<?php echo base_url() ?>/images/admin/desktop/desktop_category/Rich_texteditor.png"));
		$('#screeshotprocess_div').css('display','none');
		return false;
	}
	
	
	if(sec_type=='Catagory' || sec_type=='Popular Product' || sec_type=='Category Product')
	{
		$("#sectiondata_type").html('');
		...
		//$('#trsec_datatype').css('display','none');
		//$('#tr_noofcolumn').css('display','none');
		...
		$('#div_screenshot').append($("<img></img>").attr("src","<?php echo base_url() ?>/images/admin/desktop/desktop_category/product.png"));
		$('#screeshotprocess_div').css('display','none');
	}
	else
	{
			...
			if(sec_type=='Banner' || sec_type=='Slider' || sec_type=='Video' || sec_type=='Featured Box' || sec_type=='Grouped Banner')
			{
			...
			else if(sec_type=='Product' || sec_type=='Products Vertical section' )
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
			...
			else if(sec_type=='Slider with Product Carousel')
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
				...
				$('#sectiondata_type').append($("<option></option>").attr("value","Banner With Product").text("Banner With Product"));
				
			}
			else if(sec_type=='Vertical Carousal With Thin Banner')
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
				...
				$('#sectiondata_type').append($("<option></option>").attr("value","Carousal With Banner").text("Carousal With Banner"));
				
			}
			else if(sec_type=='Slider With Add Banner')
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
				...
				$('#sectiondata_type').append($("<option></option>").attr("value","Slider With Banner").text("Slider With Banner"));
				
			}
			else if(sec_type=='Video with Product Carousel')
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
				...
				$('#sectiondata_type').append($("<option></option>").attr("value","Video With Product").text("Video With Product"));
				
			}
			else if(sec_type=='Product Grid View')
			{		
				$("#sectiondata_type option[value='Product']").remove();
				$("#sectiondata_type option[text='Product']").remove();			
...
function select_nofcolumn()
{
	if($('#section_type').val()=='Banner' && $('#sectiondata_type').val()=='Banner')
	{
		...
		$('#col_num').append($("<option></option>").attr("value","4").text("4"));
	}
	...
	if($('#section_type').val()=='Slider' && $('#sectiondata_type').val()=='Banner')
	{
		...
		$('#col_num').append($("<option></option>").attr("value","3").text("3"));
	...
	if($('#section_type').val()=='Slider with Product Carousel' && $('#sectiondata_type').val()=='Banner With Product')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
	...
	if($('#section_type').val()=='Vertical Carousal With Thin Banner' && $('#sectiondata_type').val()=='Carousal With Banner')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
	...
	if($('#section_type').val()=='Slider With Add Banner' && $('#sectiondata_type').val()=='Slider With Banner')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
	...
	if($('#section_type').val()=='Video with Product Carousel' && $('#sectiondata_type').val()=='Video With Product')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
	...
	if($('#section_type').val()=='Product Grid View' && $('#sectiondata_type').val()=='Product')
	{
		$("#col_num option[value='1']").remove();
		$("#col_num option[text='1']").remove();
		$("#col_num option[value='2']").remove();
...
function select_imagesize()
{
	...
	else
	{
		...
		$.ajax({
			method:"POST",
			url:"<?php echo base_url(); ?>admin/Desktop_page_category/select_imagesize",
...
function populate_screenshot(img_size)
{
	...
	$.ajax({
						method:"POST",
						url:"<?php echo base_url(); ?>admin/Desktop_page_category/select_screeshot",
...
{
	if($('#section_type').val()!='Video' && $('#section_type').val()!='Product' && $('#section_type').val()!='Prodcts Vertical section' && $('#section_type').val()!='Rich Text Editor' && $('#section_type').val()!='Video with Product Carousel' && $('#section_type').val()!='Product Grid View')
	{
...
<script>
	...
	var text_remaining = text_max - text_length;
	 $('.textarea_val'+valuid).html('5/'+text_remaining);
	}
</script>