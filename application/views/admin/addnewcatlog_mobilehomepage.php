...
.alert {
    ...
    transition: opacity 0.6s; /* 600ms to fade out */
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/mobile_homepage_addcatlogjs.php'); ?>
                	<?php
					$attributes = array('onSubmit' => 'return valid_columndata()');
					echo form_open_multipart('admin/page_catlog/add_pagecatlogdata',$attributes);
					?>
                	<!--<form onSubmit="return membershipInfo()">-->
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Categories</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
						...
						<h3>Add New Categories</h3>
							<table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<input type="text" class="text2" name="section_lbltxtbox" id="section_lbltxtbox" style="width:490px; height:40px;"></td>
								</tr>
                                ...
                                <tr>
                                    ...
                                    <input type="color" class="text2" name="sectionbackg_clr" id="sectionbackg_clr" style="width:490px; height:40px;"></td>
								</tr>
                            ...
                            <div id="columninfo_div" style="background-color:#099;display:none;" align="center"></div>                            
					</div>
