                    ...
                    if ($slr_report->num_rows() > 0) {
                        ...
                        foreach ($slr_report->result() as $report_row) {
                            ...
                            ?></td>
                                ...
                                <td>
                                    <?php
                                    $query = $this->db->query("SELECT seller_id FROM review_seller WHERE seller_id='$seller_id' AND rating_type='Good' GROUP BY seller_id");
                                    if ($query->num_rows() > 0) {
                                        echo $query->num_rows();
                                    } else {
                                        echo '0';
                                ...
                                <td>
                                    <?php
                                    $query = $this->db->query("SELECT seller_id FROM review_seller WHERE seller_id='$seller_id' AND rating_type='Best' GROUP BY seller_id");
                                    if ($query->num_rows() > 0) {
                                        echo $query->num_rows();
                                    } else {
                                        echo '0';
