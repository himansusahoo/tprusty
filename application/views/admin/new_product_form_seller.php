...
url: "<?php echo base_url();?>admin/sellers/upload_product_tmp_image/<?php echo $this->uri->segment(4); ?>",
dragDrop: true,
fileName: "userfile",
returnType: "json",
showDelete: true,
...
<script>
	function valid_product_form(){ 
		...
		if(attribute_set == ''){
			...
			$('.form_content').find('#collapseSix').removeClass('in');
			$('.form_content').find('#collapseSeven').removeClass('in');
			$('.form_content').find('#collapseFour').addClass('in').removeAttr("style");
...
function image_psuh(){
	...
	<div id="content">
		...
		<div class="main-content">
			...
			echo form_open_multipart('admin/sellers/save_new_product', $attributes);
			?>
									...
									<div class="panel-body">
										<table id="albums" style="width:100%;" cellspacing="0px">
											<tr>
												...
												<td>
													<select class="seller_input" id="attribute_set" name="attribute_set" onChange="ShowAttrHeadings()">
