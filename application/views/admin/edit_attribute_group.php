...
<div id="content">    
		...
		<div class="main-content">
         ...
         <form action="<?php echo base_url().'admin/Attribute/edit_attributegroup_data' ?>" method="post">
                
					<div class="row content-header">
                    	<div class="col-md-2"><b>Edit Attribute Group</b></div>
						<div class="col-md-10">
						...
						<h3>Edit Attribute Group</h3>
							<table>
								<tr>
									...
									<td>
                                    <input type="hidden" name="atrb_grp_id" id="atrb_grp_id" value="<?php echo $result->attribute_group_id ; ?>" > 
                                    <input type="text" class="text2" name="atrb_grp_nm" id="atrb_grp_nm" value="<?php echo $result->attribute_group_name ; ?>" > 
