...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/desktop_category_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/desktop_page_category/add_pagecategorydata',$attributes);
					?>
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Section Of Categories Page</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
                        <div class="col-md-4 show_report">
                        
                         <button type="button" id="section_submit" class='all_buttons' style="background-color:#C03;float:right; font-weight:bold; height:32px; width:72px;" onClick="window.location.href='<?php echo base_url().'admin/desktop_page_category/addnewcategory_fordesktophomepage' ?>'" >
                        <i class="fa fa-refresh" aria-hidden="true"></i>&nbsp;Reset </button>
                        &nbsp;&nbsp;
							<button  type="submit" id="sectio_submit" class='all_buttons' style="background-color:#093; font-weight:bold;height:32px; width:72px;display:none">                            <i class="fa fa-floppy-o" aria-hidden="true"></i> &nbsp;Save </button>
						</div>
					</div>
...
<script>
  $(function() {
	...
	$('.chosen-select-deselect').chosen({ allow_single_deselect: true });
					...
					<div class="form_view">
						<h3>Add New Section Of Categories Page</h3>
                        <div width="100%">
                        	<!-------------------------------- Main Table Start ------------------------->
                        	<table>
                            	<tr>
                                	<td>
                                    	<!---------------------------------- Section Table Start ----------------->
                                            ...
                                            <table>
                                            	<tr>
                                                    <td> Second Level Menu Link <sup>*</sup> </td>
                                                    <td>
                                                        <select name="menu_link[]" data-placeholder="Choose Category Links"  
                                                        class="chosen-select" style="width:490px" id="catid" multiple tabindex="4">
															<?php
                                                ...
                                                <tr>
                                                    ...
                                                    <label id="lbl_section_type" style="font-size:18px;"> </label>
                                                        <select name="section_type" id="section_type" class="text2" onChange="populate_sectiondatatype(this.value)">
															...
															<option value="Slider with Product Carousel">Slider with Product Carousel</option>
															<option value="Vertical Carousal With Thin Banner">Vertical Carousal With Thin Banner</option>
															<option value="Slider With Add Banner">Slider With Add Banner</option>
															<option value="Video with Product Carousel">Video with Product Carousel</option>
															<option value="Product Grid View">Product Grid View</option>
                                    ...
                                    <td>
                             			<div id="screeshotprocess_div" style="display:none; color:#090;"> 
                                        	<img src="<?php echo base_url().'images/progress.gif' ?>" />Loading Image... </div><div id="div_imgsize"></div>
