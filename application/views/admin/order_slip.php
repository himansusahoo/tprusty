...
<div class="main">
    ...
    <div> 
                ...
                <tr >
                    <td style="width:45%;">                         
                        ...
                        <div style="float:left; width:83%;">  <?php
                            ...
                            ?> <br>
                            <?php
                            if ($rw5->prdt_color != 'not') {
                                echo "<span class='cart_attr'>Color : " . $rw5->prdt_color . '</span><br/>';
                            }
                            if ($rw5->prdt_size != 'not') {
                                echo "<span class='cart_attr'>Size : " . $rw5->prdt_size . '</span><br/>';
                            }
                            ?>
        ...
        <p style=" text-align:justify;"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;I <?php echo $rw2->fname . " " . $rw2->lname; ?>, hereby agree and confirm that the above said goods are purchased through the Seller ,<?= $rslt[0]->display_name; ?> on <?=APP_BASE?>, the above said goods are being purchased for my internal/personal purpose only and not for re-sale.I have read and understood and am legally bound by terms and conditions of sale available on <?=APP_BASE?>  </p>
    </div>
</div>
