...
$attributes = array('name' => 'seller_notification_form');
			echo form_open_multipart('admin/sellers/add_seller_notification2', $attributes);
?>
						<table>
							<tr>
								<td><label>Title <sup>*</sup>: <label></td>
								<td><input type="text" class="text2" name="title" value="">
							...
							<tr>
								...
								<td>
									<textarea name="page_content" class="text"></textarea>
							...
							<tr>
								...
								<td>
									<select name="seller" class="text2">
										...
										<?php
										foreach($sellers as $rows){
										?>
										<option value="<?=$rows->seller_id?>"><?=$rows->business_name?></option>
										<?php
										}
										?>
									</select>
