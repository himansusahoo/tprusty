...
<div id="content">    
		...
		<div class="main-content">
         ...
         <form action="<?php echo base_url().'admin/attribute/insert_new_attribute_data' ?>" method="post">
                
					<div class="row content-header">
                    	<div class="col-md-2"><b>New Attribute </b></div>
						<div class="col-md-10">
					...
					<div class="form_view">
						<h3>Create New Attribute </h3>
                            ...
                            <tr>
                                    ...
                                    <option value="<?php echo $rs->attribute_group_id; ?>"><?php echo $rs->attribute_group_name;  ?></option>
                                    <?php } ?>
                                    </select> 
								...
								<tr>
									<td style="width:20%;"> Attribute Heading Name <sup>*</sup></td>
									<td><input type="text" class="text2" name="atrb_nm" id="atrb_nm" > 
