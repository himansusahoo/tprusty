...
$(document).ready(function(){
	...
	<div id="content">    
		...
		<div class="main-content">
			...
			<div><form action="<?php echo base_url().'admin/track_orders/filter_order_intransist' ?>" method="post">	
				...
				<table class="table table-bordered table-hover">
					...
					<tr class="filter_tr">
						...
						<td>
                            ...
                            <input type="text" name="order_no" required id="order_no" value="">
						</td>
						<td>
							<!--<div class="order">
								<span >From:</span>
                    ...
                    <?php $ct=$shipment_list->num_rows(); 
					if($ct!=0){
						foreach($shipment_list->result() as $rws ){
					?>
                    <tr>
                        ...
                        <td> 
							<?php //echo substr($rws->shipping_date,0,10);  ?>
                            <?php echo $rws->shipping_date;?>
                        </td>
                        <td> 
							<?php //echo substr($rws->date_of_order,0,10);  ?>
                            <?php echo $rws->date_of_order;?>
                        </td>
