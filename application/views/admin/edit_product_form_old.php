          ...
          <div class="valid_msg_dv"></div>
			...
			<ul class="nav nav-tabs tabs-horiz">
               ...
               <!-- <li id="li_tab6"><a data-toggle="tab" href="#tab6">Inventory</a></li>
                ...
                <li id="li_tab8" onclick='showRelatedProduct("<?=$edit_product_details[0]->sku;?>");'><a data-toggle="tab" href="#tab8">Related Products</a></li>
			</ul>
<?php
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if($attr_fld_row->attribute_field_name == 'Color'){ ?>
														...
														?>
                                                            ...
                                                            <select name="attr_value[]"  onchange="prod_settingedited()">
