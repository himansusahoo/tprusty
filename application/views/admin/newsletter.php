	...
	function delete_excel_files(){
		...
		<div id="content">    
			...
			<div class="row content-header">
				...
				<div class="a-center"><?php if($this->session->flashdata('download_msg')):echo $this->session->flashdata('download_msg');endif; ?></div>
            </div>
			<div class="search2">
			...
			<div>
				<?php
					if(file_exists(FCPATH."excel_downloaded/newsletter.xls")){ ?>
