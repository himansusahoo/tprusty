...
//		}
	...
	function valid_menulabelid()
	{
		...
		{  var menu_lable_id=$('input[name=subcategory_id]:radio:checked').val();
			...
			//var selectedVal = "";
//			var selected = $("#subcategory_id input[type='radio']:checked");
          ...
          <form id="save_catgory_form" method="post" action="<?php echo base_url().'admin/Super_admin/update_pcmenusetup' ?>">
           ...
           <div class="left-sidebar"> <div id="show_menuselecterror" align="center" style="color:#F00; display:none;" > </div> 
             ...
             <input type="button" value="Add Submenu" class="btns" onClick="select_subcategory_valid()"  />-->
              <input type="button" value="Edit Menu" class="btns" onClick="valid_menulabelid()" />
  <ul id="example">
  <?php foreach($data2->result() as $rows){ ?> <!--level-1 --> 
    <li id="category_li">
      <input id="subcategory_id"  type="radio" name="subcategory_id"   value="<?php echo $rows->dskmenu_lbl_id; ?> " <?php if($pcmenu_edit->dskmenu_lbl_id==$rows->dskmenu_lbl_id){echo "checked=checked";} ?>    />
      ...
      <?php $qr=$this->db->query("select * from category_menu_desktop where parent_id='$rows->dskmenu_lbl_id' order by order_by "); 
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs->dskmenu_lbl_id; ?>"  <?php if($pcmenu_edit->dskmenu_lbl_id==$rs->dskmenu_lbl_id){echo "checked";} ?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs1->dskmenu_lbl_id; ?>"  <?php if($pcmenu_edit->dskmenu_lbl_id==$rs1->dskmenu_lbl_id){echo "checked";} ?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs2->category_id; ?>" <?php if($pcmenu_edit->dskmenu_lbl_id==$rs2->dskmenu_lbl_id){echo "checked";} ?>    />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs3->dskmenu_lbl_id; ?>"   <?php if($pcmenu_edit->dskmenu_lbl_id==$rs3->dskmenu_lbl_id){echo "checked";} ?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs4->category_id; ?>" <?php if($pcmenu_edit->dskmenu_lbl_id==$rs4->dskmenu_lbl_id){echo "checked";} ?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs5->category_id; ?>"  <?php if($pcmenu_edit->dskmenu_lbl_id==$rs5->dskmenu_lbl_id){echo "checked";} ?> />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs6->dskmenu_lbl_id; ?>"  <?php if($pcmenu_edit->dskmenu_lbl_id==$rs6->dskmenu_lbl_id){echo "checked";} ?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs7->dskmenu_lbl_id; ?>"  <?php if($pcmenu_edit->dskmenu_lbl_id==$rs7->dskmenu_lbl_id){echo "checked";} ?>  />
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs8->dskmenu_lbl_id; ?>" <?php if($pcmenu_edit->dskmenu_lbl_id==$rs8->dskmenu_lbl_id){echo "checked";} ?> />
