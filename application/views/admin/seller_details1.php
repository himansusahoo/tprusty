...
.udt{ display:none;}
		...
		<div id="content">
			...
			<div class="main-content">
					<?php $qr1=$this->db->query("SELECT a.* 
									FROM seller_account_information a LEFT JOIN seller_account b ON a.seller_id = b.seller_id
									WHERE a.seller_id='$seller_id'"); 
									$rw1=$qr1->row();
									?>
					<div class="row content-header">
						<h4 class="col-md-6"> Seller Details <?php echo $rw1 ? $rw1->pname : "Not Available"; ?> <span id="ajxtst"></span></h4>
					...
					<h3>Seller Personal Details</h3>
						<table class="table table-bordered table-hover">
                                ...
                                <tr>
									<td> Pin: </td>
									<td>
										<span class="slrp10"><?php echo $rw2->pincode; ?></span>
                                        <input type="text" name="slr_precty" class="hidden_input slrinf10" value="<?php echo $rw2->pincode;?>">
                                    </td>
                                    <td>
                                    	<span class="edt pedit10" onClick="editSlrInfo(<?=$seller_id;?>,10);">Edit</span>
                                    	<span class="edt updt10 udt" onClick="updateSlrInfo(<?=$seller_id;?>,10);">Update</span>
                                ...
                                <tr>
									<td> State: </td>
									<td>
										<span class="slrp11"><?php echo $rw2->seller_state; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf11" value="<?php echo $rw2->seller_state;?>">
                                    </td>
                                    <td>
					...
					<h3>Seller Account Details</h3>
						<table class="table table-bordered table-hover">
								...
								<tr>
									<td> Seller Name: </td>
									<td>
										<span class="slrp12"><?php echo $rw3 ? $rw3->pname : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf12" value="<?php echo $rw3 ? $rw3->pname:'';?>">
                                    </td>
                                    <td>
								...
								<tr>
									...
									<td>
										<span class="slrp13"><?php echo $rw3 ? $rw3->ac_holder_name : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf13" value="<?php echo $rw3 ? $rw3->ac_holder_name:'';?>">
                                    </td>
                                    <td>
                               ...
                               <tr>
									...
									<td>
										<span class="slrp14"><?php echo $rw3 ? $rw3->ac_number : "Not Available"; ?></span>
                                    	<input type="text" name="slr_prestate" class="hidden_input slrinf14" value="<?php echo $rw3 ? $rw3->ac_number:'';?>">
                                    </td>
                                    <td>
                                 ...
                                 <tr>
									<td> IFSC Code:</td>
									<td>
										<span class="slrp15"><?php echo $rw3 ? $rw3->ifsc_code : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf15" value="<?php echo $rw3 ? $rw3->ifsc_code:'';?>">
                                    </td>
                                    <td>
                                ...
                                <tr>
									<td> Bank Name:</td>
									<td>
										<span class="slrp16"><?php echo $rw3 ? $rw3->bank : "Not Available"; ?></span>
                                    	<input type="text" name="slr_prestate" class="hidden_input slrinf16" value="<?php echo $rw3 ? $rw3->bank:'';?>">
                                    </td>
                                    <td>
                                ...
                                <tr>
									<td> Branch Name:</td>
									<td>
										<span class="slrp17"><?php echo $rw3 ? $rw3->branch : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf17" value="<?php echo $rw3 ? $rw3->branch:'';?>">
                                    </td>
                                    <td>
                               ...
                               <tr>
									<td> City:</td>
									<td>
										<span class="slrp17"><?php echo $rw3 ? $rw3->city : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf17" value="<?php echo $rw3 ? $rw3->city:'';?>">
                                    </td>
                                    <td>
                                    	<span class="edt pedit17" onClick="editSlrInfo(<?=$seller_id;?>,17);">Edit</span>
                                        <span class="edt updt17 udt" onClick="updateSlrInfo(<?=$seller_id;?>,17);">Update</span>
									...
									<td> State:</td>
									<td>
										<span class="slrp18"><?php echo $rw3 ? $rw3->state : "Not Available"; ?></span>
                                    	<input type="text" name="slr_prestate" class="hidden_input slrinf18" value="<?php echo $rw3 ? $rw3->state:'';?>">
                                    </td>
                                    <td>
...
WHERE a.seller_id = '$seller_id' GROUP BY b.sku ORDER BY b.product_id DESC ");
//}
?>  
					...
					<table class="table table-bordered table-hover">
						...
						<tr>
                            ...
                            <td><a href="<?php echo base_url(); ?>admin/catalog/product_edit/<?=$product->product_id;?>/<?= base64_encode($this->encrypt->encode($product->sku));?>">Edit</a></td>
						</tr>
							<?php }}else{ ?>
						<tr>
                            ...
                            ?>  
								<tr>
									...
									?>
                                    	<input type="hidden" name="fldnm" value="pan">
                                        <input type="hidden" name="slr_id" value="<?=$seller_id;?>">
                                    	Address Proof Img: <input type="file" name="userfile" id="seller_panimg19" style="display:inline;"><br/>
                                       <input type="submit" name="submit" value="Update" onClick="return validate_panform()">
                                    <?php echo form_close();?>
									</td>
                                    <td>
								...
								<tr>
									...
									<?php }else{ echo "Not Available"; }?>
                                    	...
                                    	<input type="hidden" name="fldnm" value="tin">
                                        <input type="hidden" name="slr_id" value="<?=$seller_id;?>">
                                    	ID Proof Img: <input type="file" name="userfile" id="seller_tinimg20" style="display:inline;"><br/>
                                        <input type="submit" name="submit" value="Update" onClick="return validate_tinform()">
                                    <?php echo form_close();?>
									</td>
                                    <td>
								...
								<!--<?php// if(@$rw4->TAN_NO) { ?>-->
                                 <tr>
									...
									?>
                                    	<input type="hidden" name="fldnm" value="tan">
                                        <input type="hidden" name="slr_id" value="<?=$seller_id;?>">
                                    	Cancelled Cheque Img* : <input type="file" name="userfile" id="seller_tanimg21" style="display:inline;"><br/>
                                        <input type="submit" name="submit" value="Update" onClick="return validate_tanform()">
                                    <?php echo form_close();?>
									</td>
                                    <td><span class="edt pedit21" onClick="editSlrImgInfo(21);">Edit</span></td>
					...
					<h3>Store Details</h3>
						<table class="table table-bordered table-hover">
								...
								<tr>
									<td> Display name*: </td>
									<td>
										<span class="slrp12"><?php echo $rw3 ? $rw3->display_name : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf12" value="<?php echo $rw3 ? $rw3->display_name:'';?>">
                                    </td>
                                    <td>
                                    	<span class="edt pedit12" onClick="editSlrInfo(<?=$seller_id;?>,12);">Edit</span>
                                        <span class="edt updt12 udt" onClick="updateSlrInfo(<?=$seller_id;?>,12);">Update</span>
								...
								<tr>
									...
									<td>
										<span class="slrp13"><?php echo $rw3 ? $rw3->store_description : "Not Available"; ?></span>
                                        <input type="text" name="slr_prestate" class="hidden_input slrinf13" value="<?php echo $rw3 ? $rw3->store_description:'';?>">
                                    </td>
                                    <td>
                                    	<span class="edt pedit13" onClick="editSlrInfo(<?=$seller_id;?>,13);">Edit</span>
                                        <span class="edt updt13 udt" onClick="updateSlrInfo(<?=$seller_id;?>,13);">Update</span>
