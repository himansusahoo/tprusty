...
<!-- Load Google chart api -->
      ...
      function drawVisualization() {
        ...
        var data = google.visualization.arrayToDataTable([
         ...
         ['Month',<?php $i=1; $ct=count($seller_weekly_sale); foreach($seller_weekly_sale as $res_selrnm) { ?>  '<?php echo $res_selrnm->business_name;  ?>'  <?php if($i!=$ct){echo "," ;} $i++; } ?> ],
         
		<?php  //foreach($seller_weekly_sale as $res_selr_salewk) { ?>
		
		['<?php echo date('M-d-Y h:i:s A'); ?>', 
		
		<?php $j=1; $ctr=count($seller_weekly_sale); foreach($seller_weekly_sale as $res_selr_saleqnt) {  echo $res_selr_saleqnt->sale_qnt;  if($j!=$ctr){echo "," ;} $j++; }?> 
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge">
                                        <?php //$total_task=count($transfer_order_data)+count($return_orderlist)+count($replacement_orderlist)+count($graceperiod_request);
										echo  $total_task=4;
										 ?>
