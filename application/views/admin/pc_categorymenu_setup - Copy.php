...
<div id="content">  
  ...
  <?php foreach($data2->result() as $rows){ ?> <!--level-1 --> 
    <li id="category_li">
      <input id="subcategory_id"  type="radio" name="subcategory_id"   value="<?php echo $rows->dskmenu_lbl_id; ?> "    />
      <?php echo $rows->label_name; ?>
      <ul >
      <?php $qr=$this->db->query("select * from category_menu_desktop where parent_id='$rows->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct=$qr->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs->dskmenu_lbl_id; ?>"    />
				
		 <?php echo	$rs->label_name;?>
         
         <ul>
         <!--level-3-->
          <?php $qr1=$this->db->query("select * from category_menu_desktop where parent_id='$rs->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct1=$qr1->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs1->dskmenu_lbl_id; ?>"   />
         ...
         <ul>
         <!--level-4-->
          <?php $qr2=$this->db->query("select * from category_menu_desktop where parent_id='$rs1->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct2=$qr2->num_rows();
       ...
       <li>		
         ...
         <ul>
         <!--level-5-->
          <?php $qr3=$this->db->query("select * from category_menu_desktop where parent_id='$rs2->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct3=$qr3->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs3->dskmenu_lbl_id; ?>"     />
         ...
         <ul>
         <!--level-6-->
          <?php $qr4=$this->db->query("select * from category_menu_desktop where parent_id='$rs3->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct4=$qr4->num_rows();
       ...
       <li>		
		 ...
		 <?php echo	$rs4->label_name;?>
          ...
          <ul>
         <!--level-7-->
          <?php $qr5=$this->db->query("select * from category_menu_desktop where parent_id='$rs4->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct5=$qr5->num_rows();
       ...
       <li>		
         ...
         <ul>
         <!--level-8-->
          <?php $qr6=$this->db->query("select * from category_menu_desktop where parent_id='$rs5->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct6=$qr6->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs6->dskmenu_lbl_id; ?>"  />
		 ...
		 <?php echo	$rs6->label_name;?>
          ...
          <ul>
         <!--level-9-->
          <?php $qr7=$this->db->query("select * from category_menu_desktop where parent_id='$rs6->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct7=$qr7->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs7->dskmenu_lbl_id; ?>"  />
				
		 <?php echo	$rs7->label_name;?>
         
            <ul>
         <!--level-10-->
          <?php $qr8=$this->db->query("select * from category_menu_desktop where parent_id='$rs7->dskmenu_lbl_id' "); 
	  	//$rw=$qr->result();
	  	$ct8=$qr8->num_rows();
       ...
       <li>		
			<input type="radio" id="subcategory_id" name="subcategory_id" value="<?php echo $rs8->dskmenu_lbl_id; ?>"  />
						...
						<h3>Menu Information</h3>
							<table>
								<tr>
									...
									<td><input type="text" class="text2" name="menu_name" id="menu_name"></td>
								</tr>
                                <tr>
