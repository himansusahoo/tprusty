...
<script type="text/javascript" src="<?php echo base_url().'asset/ckeditor/ckeditor.js' ?>"></script>
			...
			<div id="content">  
                ...
                <?php require_once('pagedesign_setup/desktop_homepage_addsectionjs.php'); ?>
					...
					echo form_open_multipart('admin/desktop_page_setup/add_pagesectiondata',$attributes);
					?>
					<div class="row content-header">
						<div class="col-md-8"><h4><b>Add New Section Of Desktop Home Page</b></h4><div id="ssmessg"><?= $this->session->flashdata('succss_msg'); ?></div></div>
					...
					<div class="form_view">
						<h3>Add New Section Of Desktop Home Page</h3>
							<div width="100%">
                            		 <!----------------------Main table start------------------------>
                            <table>
                            <tr>
