                            ...
                            <!--Data Display from page section table start-->                            	
                                   ...
                                   <?php } ?>
                                    	...
                                    	<td><?php if($sort_i>1) {?>
                                    		...
                                    		<?php /*?><img src='<?php echo base_url().'images/icon_finder/1495193373_Stock Index Down.ico' ?>' style="width:25px;height:29px;cursor:pointer;" onClick="window.location.href='<?php echo base_url().'admin/page_single_product/single_productsortby_section_down/'.$res_secinfo['pgsection_sqlid'] ?>' " ><?php */?>
										...
										<td>
                                        <a href="<?php echo base_url().'admin/page_single_product/edit_mobile_singleproduct_section/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">
                                        <img src='<?php echo base_url().'images/icon_finder/1495194794_edit-notes.ico' ?>' style="width:30px;height:25px;cursor:pointer;"  >
                                        </a>
										&nbsp;
										<span><a style="cursor: pointer; color:#333;" href="<?php echo base_url().'admin/page_single_product/edit_mobile_singleproduct_section/'.$res_secinfo['pgsection_sqlid'] ?>" target="_blank">Edit </a></span><br>
