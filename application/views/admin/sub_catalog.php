<ul class="top-menu">
    ...
    <?php if ($this->rbac->has_role('ADMIN')) { ?>
        <li class="<?php
        if ($this->uri->segment(2) == "catalog" && $this->uri->segment(3) == "" || $this->uri->segment(3) == "product_edit") {
            echo "selected";
        }
        ?>"><a href="<?php echo base_url(); ?>admin/catalog">Manage Products</a></li>
        <li class="<?php
        if ($this->uri->segment(3) == "manage_category") {
            echo "selected";
        }
        ?>"><a href="<?php echo base_url(); ?>admin/catalog/manage_category">Manage Categories</a></li>
        <li class="<?php
        if ($this->uri->segment(2) == "attribute" || $this->uri->segment(2) == "Attribute") {
            echo "selected";
        }
        ?>"><a href="">Attributes</a>
            <ul> <li class="<?php
                if ($this->uri->segment(2) == "attribute" && $this->uri->segment(3) == "") {
                    echo "selected";
                }
                ?>"> <a href="<?php echo base_url(); ?>admin/attribute">  Manage Attribute Group</a> </li>
                <li class="<?php
                if ($this->uri->segment(2) == "attribute" && $this->uri->segment(3) == "add_new_attribute") {
                    echo "selected";
                }
                ?>"> <a href="<?php echo base_url(); ?>admin/attribute/add_new_attribute"> Manage Attribute </a></li>
