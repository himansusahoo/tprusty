...
<div class="line">&nbsp;</div>
  ...
  <tr>
   ...
   $image_cart=explode(',',$rw1->imag);
    ...
    ?> <a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#/#',"-",str_replace(" ","-",strtolower($rw1->name))).'/'.$rw1->product_id.'/'.$rw1->sku  ?>" target="_blank"><img src="<?php echo base_url().'images/product_img/'.$image_cart[0]; ?>"  width="30"></a></div>
