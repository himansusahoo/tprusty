                        ...
                        <ul>
                            ...
                            <li>  
                                <?php if (@$this->session->userdata['session_data']['user_id'] == "") { ?>
                                    <a style="margin-right: 15px;" href="<?php if (@$this->session->userdata['session_data']['user_id'] != "") {
                                    echo base_url() . 'user/wishlist';
                                } else {
                                    echo base_url() . 'user/m_login';
                                } ?>" title="your Wishlist!" class="top-wshlst" >
...
<?php /* ?><?php
  ...
  ?><?php */ ?>
                        <input type="search" id="search-text" onKeyDown="if (event.keyCode == 13)
                                                    search_url();" name="search" placeholder="Search for a Product..." autocomplete="off" required>
