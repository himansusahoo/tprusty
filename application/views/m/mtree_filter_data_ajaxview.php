	 ...
	 ?>
		...
		?>
          ...
          <?php
            ...
            ?> 
                <li class="<?php echo str_replace('_',' ',$attribute=$arrbrand[$i_arrbrand]);?>" id="<?php echo 'labelid'.$i_arr.$i_arr1.$i_arr2.$i_arrbrand.$i;?>">
