                  ...
                  $qr_clmn=$this->db->query("SELECT * FROM mobilesite_columninfo WHERE page_id='1' AND sec_id='$sec_id' AND clmn_status='active' ORDER BY ordr_by DESC  ");
                   if($qr_clmn->num_rows()>0)
                   {
                       ...
                       foreach($qr_clmn->result_array() as $res_clmn_four)
                       {
                           ...
                           $qr_act_imginfo1=$this->db->query("SELECT * FROM mobilesite_imageinfo WHERE clmn_sqlid='$clmn_sqlid1' AND image_status='active' AND ((frm_dt_tm<='$cur_dtm' AND to_dt_tm>='$cur_dtm') OR (frm_dt_tm='0000-00-00 00:00:00' OR to_dt_tm='0000-00-00 00:00:00')) ORDER BY img_sqlid ASC");
                  ...
                  ?>                    
                                ...
                                <div class="item active">
                                        <div class="row" style="margin: auto;">
                                           ...
                                           <img src="<?php echo base_url().'images/pagedesign_image/'.$res_imgdata_active['imge_nm'];?>" onclick="window.location.href='<?php echo base_url().'offers/'.$res_imgdata_active['display_url'].'/'.$res_imgdata_active['img_sqlid'] ?>'"  alt="Image" class="img-responsive" />
        ...
        <?php if($res_secdata['sec_type']=='Carousel'  && $res_secdata['sec_type_data']=='Banner' && $res_secdata['nos_column']=='3' && $res_secdata['image_size']=='119x84')
                  ...
                  ?>
                   <div class="col-xs-4 col-sm-4 col-md-4" style="padding:0;" >
                    <div id="jssor_<?=$jsor?>" style="position:relative;margin:0 auto;top:0px;left:0px;width:120px;height:84px;overflow:hidden;visibility:hidden;">                     <!-- Loading Screen -->
                                <div data-u="loading" style="position:absolute;top:0px;left:0px;background-color:<?=$res_clmn['bg_color'];?>">
                                    <div style="filter: alpha(opacity=70); opacity: 0.7; position: absolute; display: block; top: 0px; left: 0px; width: 100%; height: 100%;"></div>
                                    <div style="position:absolute;display:block;background:url('<?php echo base_url()?>mobile_css_js/new/img/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
                                </div>
                                <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:120px;height:84px;overflow:hidden;">
                  ...
                  <?php foreach($qr_imginfo->result_array() as $res_imgdata){ ?>
                   ...
                   <?php } ?>
                                ...
                                <!-- Arrow Navigator -->
                                <?php if($image_count>1){ ?>
                                <span data-u="arrowleft" class="jssora12l" style="top:0px;left:0px;width:30px;height:46px;background-position: -30px -35px;" data-autocenter="2"></span>
...
*/</style>          
             ...
             <?php /*?><div class="container" style="padding:0!important;">
    <div class="col-md-12" style="padding:0!important;">
        <div class="well">
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div class="row" style="margin: auto;">
                            ...
                            <img src="http://server-pc/moonboy/images/pagedesign_image/hbp5bwckgvlmpdx20170613160722.jpg" alt="Image" class="img-responsive">
                            half shirts
                            </a>
                            ...
                            <div class="col-sm-3">
                            <a href="#x" class="thumbnail">
                            <img src="http://server-pc/moonboy/images/pagedesign_image/smka10ye8xub7wh20170613160540.jpg" alt="Image" class="img-responsive">
                            half shirts
                            </a>
                            ...
                            <div class="col-sm-3">
                            <a href="#x" class="thumbnail">
                            <img src="http://server-pc/moonboy/images/pagedesign_image/bjgda1mituvf5gr20170612135612.jpg" alt="Image" class="img-responsive">
                            half shirts
                            </a>
                            ...
                            <div class="col-sm-3">
                            <a href="#x" class="thumbnail">
                            <img src="http://server-pc/moonboy/images/pagedesign_image/rdecqkbja7nbdui20170601131100.jpg" alt="Image" class="img-responsive">
                            half shirts
                            </a>
                    ...
                    <div class="item">
                        <div class="row" style="margin: auto;">
                            <div class="col-sm-3">
                            <a href="#x" class="thumbnail">
                            <img src="http://server-pc/moonboy/images/pagedesign_image/9xpbmvyzilj1tvh20170601131100.jpg" alt="Image" class="img-responsive">
                            half shirts
                            </a>
                            </div>
                            <div class="col-sm-3">
