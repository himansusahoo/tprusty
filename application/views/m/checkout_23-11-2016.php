...
<?php
  ...
  <div class="clearfix"></div>
    ...
    ?>
							 ...
							 <div class="cart_box">
                                   ...
                                   <!-- <a href="#"><img src="images/1.jpg"  alt=""/> </a>-->
                                     ...
                                     <a href="<?php echo base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($rw1->name)))).'/'.$rw1->product_id.'/'.$rw1->sku  ?>"   alt="">
                                    <img src="<?php echo base_url().'images/product_img/'.$image_cart[0]; ?>" ></a>
   ...
   $rw2=$qr2->row(); 
   echo "<a href="."'".base_url().'product_description/product_detail/'.preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($rw1->name))))."/".$rw1->product_id."/".$rw1->sku."'".">". $rw2->name ."</a><br><br>" ;
...
<tr>
    ...
    <td class="amnt-payble">
        Amount Payable <strong>Rs.<?php echo " ". $total_price; ?></strong>
    </td>
</tr>
