    ...
    <?php } ?>
        ...
        <?= $row_addrss->state_name . ',' . $row_addrss->country; ?><br>
                        ...
                        <div class="single-bottom">
                            <label for="adrs">
                                <input type="radio" name="addrs" id="adrs" onclick="setDefaultaddress(<?= $row_addrss->address_id; ?>)" <?php if ($cus_data != "") {
		...
		WHERE  a.sku='$rec_cart->sku' ");
               ...
               <!-- <a href="#"><img src="images/1.jpg"  alt=""/> </a>-->
                                    ...
                                    <div class="list_desc"><h4>                                    
                                            ...
                                            <?php
                                            $qr2 = $this->db->query("select name,weight from product_general_info where product_id='$rec_cart->product_id'");
                                            $rw2 = $qr2->row();
                ...
                <div id="payment_div" style="display:none; clear: both;">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading" role="tab" id="headingFive">
                            <h4 class="panel-title">
                                <a class="collapsed" role="button" data-toggle="collapse" onClick="pay_by_cod('<?= $cus_data->pin_code ?>');
                                        DrawCaptcha();" data-parent="#accordion" href="#collapseFive" aria-expanded="false" aria-controls="collapseFour" >
                                    Cash On Delivery
                                </a>
                            </h4>
                        </div>
