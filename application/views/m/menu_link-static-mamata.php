                        ...
                        <div id="collapse1" class="panel-collapse collapse">
                            <div class="panel-body">
                                <ul style="float: none; padding: 0;">
                                    ...
                                    <li>
                                        <div class="inn-single" onclick="window.location.href = '<?= APP_BASE ?>category/tablets'"> 

                                            <div class="menu-link-product-held"> 
                                                <div class="menu-link-product-held-left">
                                                    <img src="<?= APP_BASE ?>images/admin/mobile/mobile_menu/gnizdq6fmc3kjey20170609174937.jpg" onclick="window.location.href = '#'">
                                                </div> 
                                                <div class="menu-link-product-held-right">
                                    ...
                                    <li>
                                        <div class="inn-single" onclick="window.location.href = '<?= APP_BASE ?>category/mobile-accessories'"> 

                                            <div class="menu-link-product-held"> 
                                                <div class="menu-link-product-held-left">
                                                    <img src="<?= APP_BASE ?>images/admin/mobile/mobile_menu/nkz89yr5meisc0220170710122033.jpg" onclick="window.location.href = '#'">
                                                </div> 
                                                <div class="menu-link-product-held-right">
                                    ...
                                    <li>
                                        <div class="inn-single" onclick="window.location.href = '<?= APP_BASE ?>category/tablet-accessories'"> 

                                            <div class="menu-link-product-held"> 
                                                <div class="menu-link-product-held-left">
                                                    <img src="<?= APP_BASE ?>images/admin/mobile/mobile_menu/8wemydoigjtt0in20170710121059.jpg" onclick="window.location.href = '#'">
                                                </div> 
                                                <div class="menu-link-product-held-right">
                                    ...
                                    <li>
                                        <div class="inn-single" onclick="window.location.href = '<?= APP_BASE ?>category/smart-devices'"> 

                                            <div class="menu-link-product-held"> 
                                                <div class="menu-link-product-held-left">
                                                    <img src="<?= APP_BASE ?>images/admin/mobile/mobile_menu/m0es7x6xv1iqata20170619175528.jpg" onclick="window.location.href = '#'">
                                                </div> 
                                                <div class="menu-link-product-held-right">
