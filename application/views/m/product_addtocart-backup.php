 ...
 <?=ceil($rw['price'])?> </span>
     ...
     <!------------------------------------------Product Catalog Start ------------------------------------------>
		...
		?>
						...
						<div class="agile-products" class="agile-products" style="max-height: 350px; min-height: 250px;">
                         ...
                         <?php 
							...
							$cursplprc_foroff=0;
							  ...
							  $cur_splprc=0;                                		
							 ?>                            
                            <?php if($percen_off>0 && $percen_off<100 ){ ?> 
							<div class="new-tag">
                            <!--<h6>20%<br>Off</h6>-->                           
                            ...
                            <div style="margin:auto; width:100%; text-align:center;">
                             ...
                             <a style="margin:auto; text-align:center;" 
                             href="<?php echo base_url().preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(' ','-',strtolower($rw['name'])))).'/'.$rw['product_id'].'/'.$rw['sku']  ?>">
                             <img style="height: 112px;max-width: 100%;margin: auto;text-align: center;" src="<?php echo base_url();?>images/product_img/<?=$image_arr[0];?>" onerror="imgError(this);"  alt="<?=$rw['name'];?>"></a>                       
                             <?php } ?>
                            </div>
           ...
           <div  class="col-md-8 product-grids" align="right">
             ...
             <br>
   			<div id="view_more_dv" align="center">
				...
				<input style="display:none;" type="button" class="btn-sign-in" id="viewmore_prodbtnid"  value="View more" name="button" onClick="ShowMoreData('<?=$no_of_product;?>','<?=$catgstr_urlpass?>','<?php if($this->uri->segment(4) != ''){ echo $this->uri->segment(4);}else{ echo 'NOT';}?>')">
