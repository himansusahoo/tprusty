...
.product-sl-image-held img {
 ...
 <script> 
		 ...
		 $(document).ready(function() {$('#catg_link')[0].click(); }); 
		 });
...
<!-------------------------------------category extra header code end----------------------------->
       ...
       <div class="container">
    	...
    	<?php } ?>
<?php $this->db->cache_off(); if($sec_info->num_rows()>0)
	{ 
                  ...
                  <li>
                     ...
                     <?php  if(empty($dsply_img)){?>
    						...
    						<div class="ad-info">
								...
								<?php if(strlen($rw['name']) > 10){ echo substr($rw['name'],0,10).'...';}else{ echo $rw['name'];}?>
                                </a></h5>
