	     ...
	     <h3 class="tittle two"> My Order </h3>
	      ...
	      <div class="list">
                           ...
                           ?>
                                    ...
                                    <h4><a href="<?php echo base_url().preg_replace('#"#',"-",preg_replace('#/#',"-",str_replace(" ","-",strtolower($order_details_row->name)))).'/'.$order_details_row->product_id.'/'.$order_details_row->sku ?>" target="_blank">
