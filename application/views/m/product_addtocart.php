	...
	<div align="right" style="margin-right:19px; margin-bottom:10px;">
		...
		<br>
   			<div id="view_more_secnd_dv" align="center">
				...
				<input style="display:none;" type="button" class="btn-sign-in" id="sec_viewmore_prodbtnid"  value="View more" name="button" onClick="ShowMoreSingleData('<?=$no_of_product;?>','<?=$catgstr_urlpass?>','<?php if($this->uri->segment(4) != ''){ echo $this->uri->segment(4);}else{ echo 'NOT';}?>')">
