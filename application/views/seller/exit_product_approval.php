...
<?php 
if($exist_approved_products) { //var_dump($exist_approved_products); exit;
	foreach($exist_approved_products as $row) :
?>
								<tr>
									<td><?=$row->sku?></td>
									...
									<td></td>
									<td><?php $date=$row->current_date; echo $date = strstr($date, ' ', true); ?></td>
								</tr>
<?php
	endforeach;
}else{
