...
<!----------------------------------------Header Section start------------------------------------------------------>
 ...
 <div class="nav-middle"> 
       ...
       <!--<form onsubmit="search_url()"> -->  
        <input type="text" id="search-text" onKeyDown="if(event.keyCode==13) search_url();" name="search" placeholder="Search For Products,Brand and More" autocomplete="off" required >
...
<div class="nav-right">
    <ul>
		...
		<li class="log-in" onMouseOver="OverFunction()" onMouseOut="OutFunction()"> <a href="#">Hello 
             ...
             <?php } ?>
        <li class="wlist-top" >
			<a href="<?php if(@$this->session->userdata['session_data']['user_id']!=""){ echo base_url().'user/wishlist'; ?> " title="your Wishlist!" >
		...
		?>
		<li class="wlist-top" onClick="addWishlistFunction()" >
		...
		<li  class="cart-top" onMouseOver="OverFunction_cart()" onMouseOut="OutFunction_cart()" style="margin-right:5px;">
        ...
        <?php } ?>       
        <li class="track" style="background-color:white;"> 
            <a title="Support" style="background-color:white;margin-right:5px;" href="<?php echo base_url();?>contact-us"> <img src="<?php echo base_url();?>images/supports.png" style="width:32px; height:32px; margin-top:-8px;"  alt="support"> </a> 
        </li>
        <?php if(!$this->session->userdata('session_data')){ ?>
        <li class="track"> 
            <a title="Sell With Us" style="background-color:white;margin-right:5px;" target="_blank" href="<?php echo base_url();?>seller/seller"><img src="<?php echo base_url();?>images/sell_with_us.png" style="width:32px; height:32px; margin-top:-8px; margin-left: 9px;"  ></a> 
        </li>
                <?php } ?>       

        <li  style="margin-top:18px;">  
            <a  class="blog" title="Our Blog" style="background-color:white;color: black" href="https://www.moonboy.in/blog/" target="_blank"><img src="<?php echo base_url();?>images/blog.png" style="width:32px; height:32px; margin-top:-18px; margin-left: -9px;"  ></a>
        </li>
    </ul>
</div>
