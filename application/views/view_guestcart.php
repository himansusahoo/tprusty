                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="chckout-desc"> 
                                    <?php
                                    $qr2 = $this->db->query("select a.name from product_general_info a inner join product_master b on a.product_id=b.product_id  where b.sku='$rec_cart'");
                                    $rw2 = $qr2->row();
                            ...
                            <td>
                                <?php
                                $qr2 = $this->db->query("select a.description from product_general_info a inner join product_master b on a.product_id=b.product_id  where b.sku='$rec_cart'");
                                $rw2 = $qr2->row();
