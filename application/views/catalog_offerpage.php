...
<?php 
			...
			$query_fltrcatg=$this->db->query("SELECT * FROM product_filtersetup WHERE category_id IN (79) ");			
					...
					<h4>Categories</h4>
						<div class="row1 scroll-pane">
							<div class="col col-4">
                                ...
                                <label class="radio"><input type="radio" name="radio" onClick="window.location.href=''">
                                <i></i> T-Shirt
                                </label>
                                <label class="radio"><input type="radio" name="radio" onClick="window.location.href=''">
                                <i></i>Fan
