 ...
 <?php } ?>
	...
	<div class="row" style="margin-right: 0px; margin-left: 0px;">
  		<div style="width:100%; margin:auto; text-align:center; color:#000; padding:10px 0;">
							...
							foreach($qr_clmn->result_array() as $res_six_clmn)
								{
									...
									$qr_siximginfo=$this->db->query("SELECT * FROM desktopsite_imageinfo WHERE clmn_sqlid='$clmn_six_sqlid' AND image_status='active' AND ((frm_dt_tm<='$cur_dtm' AND to_dt_tm>='$cur_dtm') OR (frm_dt_tm='0000-00-00 00:00:00' OR to_dt_tm='0000-00-00 00:00:00')) ORDER BY img_sqlid DESC  ");
									$image_six_count=$qr_siximginfo->num_rows();
									
									$qr_imginfo=$this->db->query("SELECT * FROM desktopsite_imageinfo WHERE clmn_sqlid='$clmn_six_sqlid' AND image_status='active' AND ((frm_dt_tm<='$cur_dtm' AND to_dt_tm>='$cur_dtm') OR (frm_dt_tm='0000-00-00 00:00:00' OR to_dt_tm='0000-00-00 00:00:00')) ORDER BY img_sqlid DESC LIMIT 6  ");
									$image_count=$qr_imginfo->num_rows();
				?>
                <div class="item active">
                    <div class="row">
						<?php 
							foreach($qr_imginfo->result_array() as $res_imgdata){
								...
								foreach($prod_skuarr as $skuky=>$skuval)
									...
									$query_prod = $this->db->query("SELECT * , imag as catelog_img_url FROM cornjob_productsearch WHERE prod_status='Active' AND seller_status='Active' AND status='Enabled' AND (quantity > 0) GROUP BY name ORDER BY `prod_search_sqlid` DESC LIMIT 6  ");
								if($query_prod->num_rows()>0)
									{
									foreach($query_prod->result_array() as $rw)
										{
            ...
            <a class="left carousel-control" style="padding-top: 10%;" href="#carousel-example<?php echo $sec_id; ?>" data-slide="prev">
				<i class="glyphicon glyphicon-chevron-left"></i>
			</a>
			<a class="right carousel-control" style="padding-top: 10%;" href="#carousel-example<?php echo $sec_id; ?>" data-slide="next">
...
<!---<div class="container-fluid">
	<div class="row" style="margin-right: 0px; margin-left: 0px;">
		<h3>
			<span class="new-arivl"> New Arrivals1 </span>
			<button type="button" class="btn btn-danger right" style="background:#ed2541">&nbsp; View All &nbsp;</button>
		</h3>
	</div>
	<div class="section group">
		<div class="col images_1_of_3">
			  <img src="http://server-pc/moonboy_test/images/grid-img4.jpg">
		</div>
		<div class="col images_1_of_3">
			  <img src="http://server-pc/moonboy_test/images/grid-img4.jpg">
		</div>
...
<!---<div class="container-fluid">
	...
	<div class="section group">
		<div class="col1 images_1_of_5" style="margin-left:10px;">
			<img src="http://server-pc/moonboy_test/images/grid-img3.jpg">
		</div>
		<div class="col1 images_1_of_5">
			<img src="http://server-pc/moonboy_test/images/grid-img3.jpg">
		</div>
		<div class="col1 images_1_of_5">
			<img src="http://server-pc/moonboy_test/images/grid-img3.jpg">
