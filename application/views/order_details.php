...
<html lang="en">
    <head>
        ...
        <style>
            ...
            .adrs-details h3{font-size: 20px; margin-top:0px;}
            .order_img a{    color: #5d9b05;
                             text-decoration: none;}
            .order_data h3{color: #5d9b05;
                           text-decoration: none;font-size: 21px;
                           margin-top: 0;}
            .manage-order a {
                font-size: 25px;
                color: #5d9b05; padding-top:0;
            }
            .order_id1 {
                font-size: 12px;
            }
    ...
    <div class="main-content"> 
        ...
        <div class="order-details" style="width:95%;">
            <div class="col-md-6">
                <h2 class="title4"> Orders Details </h2>
                <table  class="table table-striped">
                    <tr> <td> Order ID: </td> <td> 
                            <?= @$result[0]->order_id; ?> <?php
                            @$session_order_id = $result[0]->order_id;
                            @$sess_ccavenue_ordrid = $result[0]->order_id_payment_gateway
                            ?></td> </tr>
                    ...
                    <tr> <td> Order Date: </td> <td> <?=
                            //date("d-m-Y", strtotime($result[0]->date_of_order));
                            date('M-d-Y', strtotime(@$result[0]->date_of_order))
                            ?> </td> </tr>
                    <tr> <td> Amount Paid: </td> <td> Rs. <?= @$result[0]->Total_amount; ?> <?php /* ?>&nbsp;through <?= @$result[0]->payment_type ;?> <?php */ ?> </td> </tr>
                    <tr> <td> Status : </td> <td>
                        ...
                        <input type="button" value="Revise Payment Method" onClick="show_onlinepayment()"> <?php //} else{      ?>  <!--<span style="background-color:#900; color:#FFF; font-weight:bold;">In This Order Products are Out Of Stock. </span> -->
                            ...
                            ?>
                            <?php if ($result[0]->order_status == 'Pending payment' && $result[0]->order_processstatus !== 'Order Placed Successfully By Buyer') {  //if(count($prod_qntarr)>0){   ?> 
                        <input type="button" value="Revise Payment Method" onClick="show_onlinepayment()"> <?php //} else{       ?>  <!--<span style="background-color:#900; color:#FFF; font-weight:bold;">In This Order Products are Out Of Stock. </span> -->
                                <?php
                                //} 
                            }
        ...
        <div id="onlinepay_div" style="display:none;" >
            ...
            if ($result[0]->order_status == 'Failed') {
                $ccavenue_data_arr = array(
                    ...
                    'currency' => 'INR',
                    'redirect_url' => APP_BASE . 'Online_payment/ccav_response_handler_revisepayment',
                    'cancel_url' => APP_BASE . 'Online_payment/ccav_response_handler_revisepayment',
                    'language' => 'EN',
        ...
        <div class="ordr-prdct-details" style="border-top:none;">
            <table width="95%" border="0" cellspacing="5" style="margin:auto">
                <tr>
                ...
                <tr> 
                    <td class="order_product_td">
                        ...
                        foreach ($result_product as $rows) {
                            ...
                            <div class="order_data"> 
                                <div class="col-md-5 left">
                                    ...
                                    <span class="price2" style="padding:10px 0px; text-align:left;    font-size: 15px; ">Rs. <?= $rows->sub_total_amount; ?></span>  
                                    <div class="clearfix"></div>
                                    <?php if ($result[0]->order_status == 'Delivered' || $result[0]->order_status == 'Return Requested' || $result[0]->order_status == 'Return Received') { ?>
                        ...
                        <span class="price2 total_spn" style="font-size:15px;">Total <strong>Rs. <?= $result[0]->Total_amount; ?></strong></span>
                    </td>
                </tr></table>
        </div>
        <div class="clearfix">&nbsp;</div>
