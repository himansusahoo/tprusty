         ...
         <li>
			...
			?>
			   ...
			   ?>
         		...
         		<?php /*?><label class="checkbox" style="font-size: 14px;color: #A9A8A8;line-height: 1;">
                     <input type="checkbox" class="flipswitch" id="" name="" value="" onchange="">
		  ...
		  ?>
         		...
         		<label class="checkbox" style="font-size: 14px;color: #A9A8A8;line-height: 1;">
                     <input type="checkbox" class="flipswitch" id="attrb_realvalue<?=$iattrb?>" name="attrb_realvalue[]" value="<?=trim($res_attrbval['attr_value'])?>" onchange="filter_attribute('<?=$label_name;?>','<?=$catgstr_urlpass;?>','<?php if($this->uri->segment(4) != ''){ echo $strng;}else{ echo 'NOT';}?>','<?=trim($res_attrbval['attr_id']).'-'.trim($valattrbhead);?>','<?=trim($res_attrbval['attr_value'])?>','<?=$iattrb?>')">
                      <span> <?php echo trim($res_attrbval['attr_value']);?>  </span>
                </label>
...
<!------------- Start of (Showing 1 – 12</samp> products of 100 products) ------------->            
            ...
            <div class="C5rIv_">
            <span>(Showing 1 – <samp id="show_product_count">12</samp> products of <?=$no_of_product;?> products)</span>
            </div>
            </div>
            </div>
