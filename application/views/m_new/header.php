		...
		<!-- Header Bar-->
			<div class="menu-notify">
				<div class="profile-left left">
					<h5 class="pro-link"> <a href="<?php echo base_url().'demo/mobile_test' ?>"><img src="<?php echo base_url()?>mobile_css_js/new/images/logo.png" width="150" height="55" alt=""  class="img-responsive"> </a></h5>
				</div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-69461190-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-69461190-1');
</script>
