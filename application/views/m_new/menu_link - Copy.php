...
.lifestyle-submenu li { border-bottom: 1px solid #4b4a5e;background: #444359; }
...
.lifestyle-submenu ul li a:hover{background:#F39;}
</style>		
    ...
    <!--------------------------------- product list Child-menu start here------------------------------------>
        ...
        <button class="first-accordion">
         ...
         <li>
            ...
            <?php if($res_arrow->menu_image!='') {?>  <img src="<?php echo base_url().'images/admin/mobile/mobile_menu/'.$res_arrow->menu_image;?>" class="sbdCategoryIcon"> <?php } ?>
            
            <?=$res_arrow->label_name ?><i class="fa fa-chevron-down"></i></div>
            <ul class="lifestyle-submenu">
             <?php foreach($qr->result() as $rs){ ?>
            	 <?php if($rs->menu_image!=''){ ?>
                    ...
                    <div class="pro-1">                   
                    <img src="<?php echo base_url().'images/admin/mobile/mobile_menu/'.$rs->menu_image;?>" onclick="window.location.href='#'">
             	...
             	<?php }else { ?> 
             	 <li><a href="#"><?=$rs->label_name?></a></li>
              	<?php 	} // if image not found condition end ?>
              <?php } ?>
                    ...
                    <div class="brands_products" style="clear: both;">
                          <ul>              
                            <li style="padding:7px; margin:auto; width:100%; border-bottom:1px solid #ccc;">
                                <a style=" font-size:14px;" href="#"><?=$res_arrow->label_name?></a>
                            </li>                
                          </ul>
