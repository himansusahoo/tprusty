...
?>
    ...
    <div>
      <img src="https://www.moonboy.in/images/pagedesign_image/hhv2n1iul7dzsab20170601142745.jpg">
      <p style="font-size:13px; color:#333; text-align:center;padding-bottom: 5px;">1st Image</p>
    </div>
    <div>
      <img src="https://www.moonboy.in/images/pagedesign_image/2aythjv9amdlox420170530130425.jpg">
      <p style="font-size:13px; color:#333; text-align:center;padding-bottom: 5px;">1st Image</p>
    </div>
    <div>
      <img src="https://www.moonboy.in/images/pagedesign_image/cigapozuha5isd220170601142745.jpg">
      <p style="font-size:13px; color:#333; text-align:center;padding-bottom: 5px;">1st Image</p>
    </div>
    <div>
       <img src="https://www.moonboy.in/images/pagedesign_image/ghig24zimtntqv920170601142745.jpg">
...
<iframe style="padding:4px; margin-top:4px;" width="100%" height="200" src="<?=$res_imgdata['URL']?>" frameborder="0" allowfullscreen></iframe>
 ...
 <div class="slider autoplay" style="width:100%; margin:auto;">
                    ...
                    <div class="price"> <i class="fa fa-inr" aria-hidden="true"></i> 399 </div>
                                                                
                                                                 
                                <div class="view view-fifth">    
                                  <a href="http://server-pc/moonboy/battery-for-karbonn--a-6new/665/ACGJ-19-KB-BTR-A-6N">
                                  <img src="http://server-pc/moonboy/images/product_img/catalog_a6n.jpg" class="wow flipInY grow" alt="Battery For Karbonn  A-6New" style="width:76px; height:98px;">
                                   ...
                                   <a href="http://server-pc/moonboy/battery-for-karbonn--a-6new/665/ACGJ-19-KB-BTR-A-6N" title="wallet">Battery For Karbonn ...</a> 
                                        <!-- price calculation div start here --><br>
                                        <div class="price-box">
                                                                       
                                		<span class="regular-price" style="color:#CCC; text-decoration:line-through"> <i class="fa fa-inr" aria-hidden="true"></i> 1020 </span><br>
                                
                                        <span class="regular-price" style="color:#F90;text-decoration:line-through"> <i class="fa fa-inr" aria-hidden="true"></i> 485 </span><br>
               ...
               <?php 
                  ...
                  $qr_clmn=$this->db->query("SELECT * FROM mobilesite_columninfo WHERE page_id='1' AND sec_id='$sec_id' AND clmn_status='active' ORDER BY ordr_by DESC  ");
                   ...
                   <div class="support">
                    ...
                    <img width="90%" src="<?php echo base_url().'images/product_img/'.$dsply_img;?>" />
                    </div>
