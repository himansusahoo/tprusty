...
class Existingproduct_addtemplate Extends CI_Controller {
    ...
    function download_extprodtemplate() {
        if ($this->session->userdata('logged_in')) {
            ...
            $data['exist_product'] = $this->Existingproductadd_temmodel->select_existprodtemplat($catg_id, $attr_group_id, $productids);
