...
class Product_description extends CI_Controller {
	...
	function product_addtocart()
	{
		...
		$data['data'] = $this->Product_descrp_model->modf_retrieve_category_meta_info($dskcatgid_id);
	...
	function product_addtocart_filter()
	{
		...
		$data['data'] = $this->Product_descrp_model->modf_retrieve_category_meta_info($catg_id);
