! function(e) {
	//void 0 == e.fn.ajaxForm && e.getScript("img_uplod_script/jquery.form.js");
	//void 0 == e.fn.ajaxForm && e.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "malsup.github.io/jquery.form.js");
	void 0 == e.fn.ajaxForm && e.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "cdnjs.cloudflare.com/ajax/libs/jquery.form/3.51/jquery.form.js");
	...
	a.fileapi = void 0 !== e("<input type='file'/>").get(0).files, a.formdata = void 0 !== window.FormData, e.fn.uploadFile = function(t) {
		...
		function l(a, t, r) {
			for (var o = 0; o < r.length; o++) if (n(t, a, r[o].name)) if (a.allowDuplicates || !d(t, r[o].name)) /*if (-1 != a.maxFileSize && r[o].size > a.maxFileSize) a.showError && e("<div class='" + a.errorClass + "'><b>" + r[o].name + "</b> " + a.sizeErrorStr + s(a.maxFileSize) + "</div>").appendTo(t.errorLog);*/
			
			if (-1 != a.maxFileSize && r[o].size < a.maxFileSize) a.showError && e("<div class='" + a.errorClass + "'><b>" + r[o].name + "</b> " + a.sizeErrorStr + "</div>").appendTo(t.errorLog);
			
			/*else if (-1 != a.minFileSize && r[o].size > a.minFileSize) a.showError && e("<div class='" + a.errorClass + "'><b>" + r[o].name + "</b> " + a.sizeErrorStr + s(a.minFileSize) + "</div>").appendTo(t.errorLog);*/
		...
		var w = e.extend({
			...
			sizeErrorStr: "is not allowed.<br/> Allowed Minimum Image Resolution : 500 X 500",
