$(document).ready(function() {
	...
	$('#datepicker-example15-start').Zebra_DatePicker({
        //direction: [true, 30],
        pair: $('#datepicker-example15-end')
    });

    $('#datepicker-example15-end').Zebra_DatePicker({
        direction: [1, false]
    });
	
	$('#datepicker-example16-start').Zebra_DatePicker({
        //direction: [true, 30],
		direction: true,
        pair: $('#datepicker-example16-end')
    });

    $('#datepicker-example16-end').Zebra_DatePicker({
        direction: [1, false]
    });
